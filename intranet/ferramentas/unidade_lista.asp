		...
		<span id='divUnid'>
			...
			<%Do while Not rs_unid.EOF
				...
				<tr onmouseover="mOvr(this,'#CFC8FF');" onmouseout="mOut(this,'');">			
					...
					<td valign="middle">&nbsp;<a href="javascript:void(0);" onClick="window.open('ferramentas/unidade_cad.asp?cd_unidade=<%=cd_unidade%>&status=<%=cd_status%>&acao=editar&jan=1','Altera_nome','width=550,height=400,scrollbars=1')" return false;">&nbsp;<%=nm_unidade%></a></td>
