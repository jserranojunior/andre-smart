...
<%If  busca_fornecedor = "" Then '*** Mostra campo normal ***%>
...
<%Elseif busca_fornecedor = "todos" Then '*** Mostra campo normal ***%>
...
<%Elseif IsNumeric (busca_fornecedor) then ' *** Mostra Campo não numérico ***%>
...
<%Elseif not IsNumeric (busca_fornecedor) then%>
...
<%end if%>
<br>
<span style="color:silver;"><%=busca_fornecedor%></span>