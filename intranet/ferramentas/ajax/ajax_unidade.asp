...
<%Elseif unidade = "todos" Then '*** Mostra campo normal ***%>
	...
	<tr onmouseover="mOvr(this,'#CFC8FF');" onmouseout="mOut(this,'');">			
		...
		<td valign="top">&nbsp;<a href="javascript:void(0);" onClick="window.open('ferramentas/unidade_cad.asp?cd_unidade=<%=cd_unidade%>&status=<%=cd_status%>&acao=editar&jan=1','Altera_nome','width=580,height=400,scrollbars=1')" return false;">&nbsp;<%=nm_unidade%></td>
...
<table border="0" width="500">
	...
	<tr  onmouseover="mOvr(this,'#CFC8FF');" onmouseout="mOut(this,'');">
		...
		<%cd_unidade = rs_unid("cd_codigo")
		nm_unidade = rs_unid("nm_unidade")%>
		<td>&nbsp;<a href="javascript:void(0);" onClick="window.open('ferramentas/unidade_cad.asp?cd_unidade=<%=cd_unidade%>&status=<%=cd_status%>&acao=editar&jan=1','Altera_nome','width=580,height=400,scrollbars=1')" return false;"><%=nm_unidade%></a></td>
