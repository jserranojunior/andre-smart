...
<body>
<brclass="no_print">
<tableclass="no_print" style="border:3 solid <%=str_tb_cor%>; left:150px;" align="center">
	<%if session_cd_usuario = 46 then%><tr><td colspan="2" align="center"><span style="font-size:9px; color:gray;">(patrimonio_serv_vencimento.asp)</span></td></tr><%end if%>
	...
	<tr style="border:1 solid orange; background-color:silver;">
		<td colspan="100%" align="center"><B>LISTAGEM DE MANUTENÇÕES <%=str_titulo%></B></td>
	</tr>
	<tr>
		<td>&nbsp; Ano:</td>
	...
	<tr>		
		...
		<%if str_tipo = "serv_confirmadas" then%>
			<a href="patrimonio.asp?tipo=serv_vencer"><img src="../imagens/ic_clock.gif" alt="Vencendo" border="0"></a>
		<%elseif str_tipo = "serv_vencer" then%>
			<a href="patrimonio.asp?tipo=serv_confirmadas"><img src="../imagens/check_ok.gif" alt="Confirmadas" border="0"></a>
		<%end if%>&nbsp;
...
<table border="1" style="border:1px solid black; border-collapse=collapse;" align="center">
	...
	<tr style="background-color:#494949; color:#FFFFFF;">
		<td colspan="9" align="center"><b style="font-size:15px;"><%=ucase(nm_unidade)%></b></td>
	</tr>
	<tr style="background-color:gray; color:#FFFFFF;">
		<td colspan="9" align="center"><b style="font-size:12px;">
	...
	<tr><td colspan="9"><div id="divPatrimonio_manut"></div></td></tr>
...
<%if strcd_unidade <> "" Then
	...
	strsql = "SELECT DISTINCT cd_codigo, no_patrimonio, cd_posicao, nm_equipamento_novo FROM VIEW_Patrimonio_lista_vencimento WHERE (cd_unidade = '"&strcd_unidade&"') AND (tipo_manut IS NOT NULL) AND (tipo_manut = "&i&") ORDER BY cd_posicao, nm_equipamento_novo, no_patrimonio"
	...
	loop
		...
		lista_patrimonio = mid(lista_patrimonio,2,len(lista_patrimonio))%>
					...
					<%For Each lista_item In lista_array
						...
						Set rs_pat = dbconn.execute(xsql)
							...
							'end if
								...
								if cab_num = 0 Then%>
								<tr><td colspan="9" align="center"><b><%if i = 1 then%>PREVENTIVA<%elseif i = 2 then%>CALIBRAÇÃO<%elseif i = 3 then%>SEGURANÇA ELÉTRICA<%end if%></b></td></tr>
								<tr style="background-color:silver; color:#4a4a4a">
									<td>&nbsp;</td>
									<td align="center"><b>Nome</b></td>
									<td align="center"><b>Pat<%'=cd_categoria%></b></td>
									<td align="center"><b>Marca</b></td>
									<td align="center"><b>Modelo</b></td>
									<td align="center"><b>Nº Série</b></td>
									<td align="center"><b>Periodicidade</b></td>
							...
							<%'if confirmacao = 1 Then
								if not rs_pat.EOF then
									...
									<tr onmouseover="mOvr(this,'#CFC8FF');" onmouseout="mOut(this,'');">
										<td align="center" style="background-color:<%=cor_vencimento%>;"class="no_print"><%=zero(num_linha)%></td><td align="center" style="background-color:white;"class="ok_print"><%=zero(num_linha)%></td>
										<td onclick="window.open('patrimonio/<%=abre_pag%>.asp?tipo=cadastro&cd_pat_codigo=<%=cd_patrimonio%>&acao=alterar','Alterações','width=700,height=<%=tamanho_janela%>'); return false;"><%=nm_equipamento_novo%></td>
										...
										<td><a href="#" javascript:void(0); onclick="patrimonio_manut_confirm(<%=cd_patrimonio%>,<%=tipo_manut%>,<%=cd_categoria%>,<%=cod_confirma%>,'1/<%=month(dt_plan_prev)&"/"&ano_sel%>')">-</a><!-- cd_pat:<%=cd_patrimonio%> / man: <%=tipo_manut%> / cat<%=cd_categoria%> / <%=month(dt_plan_prev)&"/"&ano_sel%>--></td>
									</tr>
			...
			'wend%>
	<tr>
		<td><img src="../imagens/px.gif" alt="" width="20" height="10" border="0"></td>
		<td style="border-left:1px solid white;"><img src="../imagens/px.gif" alt="" width="100" height="1" border="0"></td>
		<td style="border-left:1px solid white;"><img src="../imagens/px.gif" alt="" width="40" height="1" border="0"></td>
		<td style="border-left:1px solid white;"><img src="../imagens/px.gif" alt="" width="70" height="1" border="0"></td>
		<td style="border-left:1px solid white;"><img src="../imagens/px.gif" alt="" width="70" height="1" border="0"></td>
		<td style="border-left:1px solid white;"><img src="../imagens/px.gif" alt="" width="90" height="1" border="0"></td>
		<td style="border-left:1px solid white;"><img src="../imagens/px.gif" alt="" width="70" height="1" border="0"></td>
		<!--td><img src="../imagens/px.gif" alt="" width="10" height="1" border="0"></td-->
		<td style="border-left:1px solid white;"><img src="../imagens/px.gif" alt="" width="30" height="1" border="0"></td>
		<td style="border-left:1px solid white;"><img src="../imagens/px.gif" alt="" width="5" height="1" border="0"></td>
	</tr>
	<%lista_patrimonio = ""
	cab_num = 0
	num_linha = 1
	...
	<tr><td colspan="9"><b>TOTAL: <%=cat_1_1+cat_2_1+cat_3_1+cat_4_1+cat_5_1+cat_6_1+cat_7_1+cat_8_1+cat_9_1+cat_10_1+cat_11_1+cat_12_1+cat_13_1+cat_14_1+cat_15_1+cat_1_2+cat_2_2+cat_3_2+cat_4_2+cat_5_2+cat_6_2+cat_7_2+cat_8_2+cat_9_2+cat_10_2+cat_11_2+cat_12_2+cat_13_2+cat_14_2+cat_15_2+cat_1_3+cat_2_3+cat_3_3+cat_4_3+cat_5_3+cat_6_3+cat_7_3+cat_8_3+cat_9_3+cat_10_3+cat_11_3+cat_12_3+cat_13_3+cat_14_3+cat_15_3%></b></td></tr>
</form>
</table>
<!--pclass="no_print"><%'=lista_num_pat%> </p--><br>
