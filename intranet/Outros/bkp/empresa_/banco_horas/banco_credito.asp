			...
			<table width="650" cellspacing="1" cellpadding="1" border="0" class="textoPadrao">
				...
				<%'*********************************************************
				  ...
				  '*********************************************************
					...
					<tr align="center">
						...
						%>
						<a href=banco_horas_cred.asp?mes_sel=<%=mes_ant%>&ano_sel=<%=ano_ant%>><%=mes_selecionado(mes_ant)%>/<%=ano_ant%></a></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr align="center">
					    <td><a href=banco_horas_cred.asp?mes_sel=<%=mes_prod%>&ano_sel=<%=ano_prod%>><b><%=mes_selecionado(mes_prod)%>/<%=ano_prod%></b></a></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr align="center">
						...
						%>
						<a href=banco_horas_cred.asp?mes_sel=<%=mes_prox%>&ano_sel=<%=ano_prox%>><%=mes_selecionado(mes_prox)%>/<%=ano_prox%></a>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						</td>
					</tr>
				...
				<%'*********************************************************
				  ...
				  '*********************************************************
					...
					%>
					<tr onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('banco_horas_cred.asp?mes_sel=<%=mes_sel%>&ano_sel=<%=ano_sel%>&cd_codigo=<%=cd_codigo%>');" onmouseout="mOut(this,'');">
						<td>&nbsp;</td>
				...
				<tr bgcolor="<%=strcor%>">
					...
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td colspan="2" align="center">&nbsp;Total trabalhado no mês: </td>
			   ...
			   <%if acao = "editar" then
				...
				<tr bgcolor="<%=strcor%>">
					...
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td colspan="2">&nbsp;Total trabalhado no mês: </td>
				...
				<tr bgcolor="<%=strcor%>">
					...
					<td align="right"><b><%=total_mes(cd_carga_horaria)%> h/mês</b></td>
					<td>&nbsp;</td>
				</tr>
				<%
