				...
				<%'*********************************************************
				  ...
				  '*********************************************************
					...
					<tr>
						...
						<td colspan="9">[<a href="empresa_funcionarios_horas.asp">Mudar Mês</a>]  &nbsp;&nbsp;/  &nbsp;&nbsp;[<a href="empresa_funcionarios_obs.asp?mes_sel=<%=mes_sel%>&ano_sel=<%=ano_sel%>">Mudar Cooperado]  &nbsp;&nbsp;/  &nbsp;&nbsp; [<a href="empresa_funcionarios_obs.asp?mes_sel=<%=mes_sel%>&ano_sel=<%=ano_sel%>&cd_codigo=<%=cd_codigo%>&tela=1">Tela inteira</a>:<a href="empresa_funcionarios_obs.asp?mes_sel=<%=mes_sel%>&ano_sel=<%=ano_sel%>&cd_codigo=<%=cd_codigo%>&tela=">Tela normal</a>]</td>
					</tr>
