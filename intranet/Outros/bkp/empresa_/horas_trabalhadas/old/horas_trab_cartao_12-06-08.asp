			...
			<table width="100%" cellspacing="1" cellpadding="1" border="0" class="textoPadrao">
				...
				<%'*********************************************************
				  ...
				  '*********************************************************
					...
					<tr>
						<td>&nbsp;</td>
						<td colspan="9">[<a href="empresa_funcionarios_horas.asp">Mudar Mês</a>]  &nbsp;&nbsp;/  &nbsp;&nbsp;[<a href="empresa_funcionarios_horas.asp?mes_sel=<%=mes_sel%>&ano_sel=<%=ano_sel%>">Mudar Cooperado]  &nbsp;&nbsp;/  &nbsp;&nbsp; [<a href="empresa_funcionarios_horas.asp?mes_sel=<%=mes_sel%>&ano_sel=<%=ano_sel%>&cd_codigo=<%=cd_codigo%>&tela=1">Tela inteira</a>:<a href="empresa_funcionarios_horas.asp?mes_sel=<%=mes_sel%>&ano_sel=<%=ano_sel%>&cd_codigo=<%=cd_codigo%>&tela=">Tela normal</a>]</td>
					</tr>
								...
								<div class="divrolagem">
									<table width="100%" cellspacing="1" cellpadding="1" border="0" class="textoPadrao">
										<tr bgcolor=#FFFFFF>
											...
											<td><img src="imagens/blackdot.gif" width=80 height=0></td>
											<td><img src="imagens/blackdot.gif" width=111 height=0></td>
	...
	'if data_entrada_day = "" AND dt_data <> "" then
		'if data_entrada_day = "" then 'AND cd_folga = "1" then%>
					<tr bgcolor="#DFEADF" onmouseover="mOvr(this,'#CFC8FF');" onmouseout="mOut(this,'#DFEADF');">
						...
						<input onclick="javascript:JsDelfolga('<%=cd_codigo%>','<%=cd_cod_folga%>','<%=cd_folga%>')" type="button" value="A" title="Apagar">
						</td>
...
Loop
			...
			'			Loop
				...
				<tr bgcolor="<%=strcor%>">
					...
					<td><img src="imagens/blackdot.gif" width=1 height=0></td>
					<td>&nbsp;Carga diária: </td>
					<td align="right"><b><%=total_mes(carga_diaria)%> h/dia</b></td>
					<td colspan="3"><img src="imagens/blackdot.gif" width=1 height=0><!--input type="submit" value="<%'=acao%>"--></td>
				</tr>
				<tr bgcolor="<%=strcor%>">
					<td><img src="imagens/blackdot.gif" width=1 height=0></td>
