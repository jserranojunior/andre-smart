								...
								<td valign="top" align=center>
									...
									<%End if%>
										...
										<tr>
											...
											<td  class="txt_cinza"><input type="text" name="cd_ctps" value="<%=str_ctps%>" size="20" maxlength="20" class="inputs"> Série <input type="text" name="cd_ctps_serie" size="5" class="inputs" maxlength="5" value="<%=str_ctps_serie%>"></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											<td  align="right" class="txt_cinza">Nº de dependentes</td>
											<td  class="txt_cinza"><input type="text" name="cd_qtd_dependentes" value="<%=strqtd_dependentes%>" size="5" maxlength="5" class="inputs"></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											<td  align="right" class="txt_cinza">Nº de filhos</td>
										...
										<tr>
											<td>&nbsp;</td>
											<td  align="right" class="txt_cinza">Assistencia Médica</td>
										...
										<tr>
											<td>&nbsp;</td>
											<td  align="right" class="txt_cinza">Cartão SPTRANS</td>
										...
										<tr>
											<td>&nbsp;</td>
											<td  align="right" class="txt_cinza">Vale refeição</td>
