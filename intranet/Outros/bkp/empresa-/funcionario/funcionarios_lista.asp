			...
			<table width="98%" border="0" cellspacing="0" cellpadding="0" class="textoPadrao">
				<tr bgcolor=#c0c0c0>
					...
					<td valign="top" width="30%" class="textopadrao">					
						<a href="empresa.asp?tipo=lista&ordem="><b>Nome</b></a>
					</td>
					<td valign="top" width="20%" class="textopadrao">					
						<b>Sobrenome</b>
					</td>
					<td valign="top" width="20%">					
						<a href="empresa.asp?tipo=lista&ordem=nm_sigla"><b>Unidade</b class="textopadrao"></a>
					</td>
...
'				 END IF
				...
				%>
				 <tr onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('empresa.asp?tipo=cadastro&pag=<%=strpag%>&cod=<%=rs("cd_codigo")%>&busca=<%=strbusca%>');" onmouseout="mOut(this,'');">
				...
				<td valign="top" >					
						...
						<td valign="top">					
						<font color="<%=strcor%>"><%=nm_sigla%></font>
					</td>
