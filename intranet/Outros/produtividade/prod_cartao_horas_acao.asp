...
xsql ="up_cartao_horas_insert @cd_codigo="&cd_codigo&",@data_entrada='"&data_entrada&"', @data_saida='"&data_saida&"',@data_saida_interv='',@data_entr_interv='', @cd_status="&cd_status&",@cd_unidades='"&cd_unidades&"',@cd_funcao='"&cd_funcao&"'"
dbconn.execute(xsql)
