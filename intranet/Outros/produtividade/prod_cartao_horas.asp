	...
	<tr>
		<td align="center">
			<table width="650" cellspacing="1" cellpadding="1" border="0" class="textoPadrao">
					<tr>
						<td colspan="100%"><b>PRODUTIVIDADE - <font color="red">Horas Trabalhadas</font></b></td>
					</tr>
					<tr bgcolor=#cococo>
				...
				<%'*********************************************************
				  ...
				  '*********************************************************
					...
					<tr align="center">
						...
						%>
						<a href=produtividade.asp?mes_sel=<%=mes_ant%>&ano_sel=<%=ano_ant%>><%=mes_selecionado(mes_ant)%>/<%=ano_ant%></a></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr align="center">
					    <td><a href=produtividade.asp?mes_sel=<%=mes_prod%>&ano_sel=<%=ano_prod%>><b><%=mes_selecionado(mes_prod)%>/<%=ano_prod%></b></a></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr align="center">
						...
						%>
						<a href=produtividade.asp?mes_sel=<%=mes_prox%>&ano_sel=<%=ano_prox%>><%=mes_selecionado(mes_prox)%>/<%=ano_prox%></a>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						</td>
					</tr>
				...
				<%'*********************************************************
				  ...
				  '*********************************************************
					...
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td colspan="4">[<a href="produtividade.asp">Mudar Mês</a>] &nbsp;&nbsp; <b><%=mes_selecionado(mes_sel)%>/<%=ano_sel%></b></td>
					</tr>
					<tr bgcolor=#cococo>
						<td align=center colspan="100%"><img src="imagens/px.gif"  height=0></td>
					</tr>
					...
					xsql = "up_funcionarios_lista @cd_codigo='', @ordem='nm_nome,nm_sobrenome', @condicao=''"
					...
					%>
					<tr onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('produtividade.asp?mes_sel=<%=mes_sel%>&ano_sel=<%=ano_sel%>&cd_codigo=<%=cd_codigo%>');" onmouseout="mOut(this,'');">
						<td>&nbsp;</td>
				...
				<%'*********************************************************
				  ...
				  '*********************************************************
					...
					<tr>
						<td>&nbsp;</td>
						<td colspan="5">[<a href="produtividade.asp">Mudar Mês</a>]  &nbsp;&nbsp;/  &nbsp;&nbsp;[<a href="produtividade.asp?mes_sel=<%=mes_sel%>&ano_sel=<%=ano_sel%>">Mudar Cooperado]</td>
					</tr>
			   ...
			   <%if acao = "editar" then
				...
				%>
				<form name="form" action="produtividade/prod_cartao_horas_acao.asp" id="form" method="post">
...
{
		document.location.href('produtividade.asp?mes_sel='+cod_a1+'&ano_sel='+cod_a2+'&cd_codigo='+cod_a3+'&acao=inserir');
}
function JsEdit(cod_a, cod_b, cod_c, cod_d)
{
		document.location.href('produtividade.asp?dia_sel='+cod_a+'&mes_sel='+cod_b+'&ano_sel='+cod_c+'&cd_codigo='+cod_d+'&acao=editar');
}
function JsDelete(cod1, cod2)
{
  if (confirm ("Tem certeza que deseja excluir?"))
	  {
		document.location.href('produtividade/prod_cartao_horas_acao.asp?cd_codigo='+cod1+'&cd_cod_horas='+cod2+'&acao=excluir&mesentrada=<%=mes_entrada%>&anoentrada=<%=ano_entrada%>');
	  }
}
</SCRIPT>
</body>
