			...
			<table width="650" border="0" cellspacing="2" cellpadding="0" bordercolordark="#FFFFFF" bordercolorlight="#efefef">
				...
				<tr id="ok_print"><td colspan="100%"><img src="imagens/blackdot.gif" width="100%" height="2"></td></tr-->
					...
					<tr bgcolor="darkgray">
						...
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao.asp?strtop=20&tipo=pendentes&org=equip&ver=<%=ver%>"><b>EQUIPAMENTO/<br>INSTRUMENTAL.</b></a></td>	
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><b>PAT</b></td>	
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						...
						<td><img src="../imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao.asp?strtop=20&tipo=pendentes&org=sit&ver=<%=ver%>"><b>diferença</b></a></td>
						<%end if%>
				</tr>
...
'		condicoes = " Where fecha IS NULL OR fecha = 0"
		...
		'condicoes = " Where fecha IS NULL AND nm_solicitante <> '"&solicitante&"' "&filtro&" "&cond_icoes&" OR fecha = 0 AND nm_solicitante <> '"&solicitante&"' "&filtro&" "&cond_icoes&""
		...
		condicoes = " Where fecha IS NULL AND nm_solicitante <> '"&solicitante&"' OR fecha = 0 AND nm_solicitante <> '"&solicitante&"'"'prev_retorno < data_hoje "
		strtop = "1000"
...
<%'3º
			...
			Do while not rs.EOF
				...
				<tr onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:;" onmouseout="mOut(this,'');">
						...
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><a href="../manut_os_andamento.asp?cd_codigo=<%=cd_codigo%>&campo=cd_codigo"><font color="<%=cor_aviso%>"><%=num_os%></font></a></td>
						<!--td><img src="imagens/px.gif" width="1" height="1"></td>
						...
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><a href="../manut_os_andamento.asp?cd_codigo=<%=cd_codigo%>&campo=cd_codigo"><font color="<%=cor_aviso%>"><%'=dt_entrada%><%=dt_manut_orc%></font></a></td>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						...
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><a href="../manut_os_andamento.asp?cd_codigo=<%=cd_codigo%>&campo=cd_codigo"><font color="<%=cor_aviso%>"><%=dt_prev_retorno%></font></a></td>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><a href="../manut_os_andamento.asp?cd_codigo=<%=cd_codigo%>&campo=cd_codigo"><font color="<%=cor_aviso%>"><%=nm_avaliacao%></font></a></td>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><a href="../manut_os_andamento.asp?cd_codigo=<%=cd_codigo%>&campo=cd_codigo"><font color="<%=cor_aviso%>"><%=nm_situacao%></font></a></td>
						<%if strsession = "22" Then%>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
...
loop%>
				...
				<tr class="textopequeno" id="no_print"><td colspan="7">&nbsp;</td></tr>
					...
					<%'end if%>
					<%'if strsession = 2 Then%>
					<tr id="no_print"><td colspan="100%"><a href="manutencao.asp?ver=old">Versão anterior</td></tr>
					<%'end if%>
				</table></td></tr></table>
				<p id="noprint">Ver.2.2</p>
