...
<table align="center" border="0">
	...
	'end if
		...
		condicoes = " Where fecha = 0  "&cond_icoes&""
...
<%'3º
			...
			Do while not rs.EOF
				...
				<tr onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:;" onmouseout="mOut(this,'');">
						...
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><a href="../manut_os_andamento.asp?cd_codigo=<%=cd_codigo%>&campo=cd_codigo"><font color="<%=cor_aviso%>"><b><%=nm_situacao%></b></font></a></td>
						<%if strsession = "200" Then%>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
...
ordenacao = ordenacao + 1%>
				<tr><td colspan="100%">SELECT <%=selecao%> <br>
										FROM <%=tabela%><br>
										<%=condicoes%><%=criterios%></td></tr>
				<%
order = ordenacao
loop%>
