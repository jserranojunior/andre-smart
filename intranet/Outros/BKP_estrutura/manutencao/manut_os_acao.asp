...
Elseif acao = "2" AND tipo = "os" Then
'Modifica os dados - Fecha a O.S.
xsql = "up_os_fechamento @num_os='"&num_os&"', @fecha='"&fecha&"'"
action = "editado com sucesso"
dbconn.execute(xsql)

response.redirect("../manutencao.asp?cd_codigo="&cd_os&"&campo=num_os")


'******************************* Os - Modifica **********************************************

Elseif acao = "3" AND tipo = "os" Then
'Modifica os dados
...
Elseif acao = "1" AND tipo = "manutencao" Then
'Insere dados
...
Elseif acao = "2" AND tipo = "manutencao" Then
'Modifica os dados
...
'Elseif acao = "3" AND tipo = "manutencao" Then
'Modifica os dados - Fecha a O.S.
...
Elseif acao = "1" AND tipo = "avaliacao" Then
'Insere dados
...
Elseif acao = "4" AND tipo = "encerramento" Then
...
'******************************* Orçamento - Insere ************************************************
'????????????????????????????????????????????????????????????????????????????????????????????????????
Elseif acao = "1" AND tipo = "orcamento" Then
...
'******************************* Orçamento - Modifica ***********************************************
'????????????????????????????????????????????????????????????????????????????????????????????????????
Elseif acao = "2" AND tipo = "orcamento" Then
'Modifica os dados
...
response.redirect("../manutencao.asp?cd_codigo="&cd_os&"&campo=num_os&obs="&observacoes&"")
...
Elseif acao = "1" And tipo = "cadastra_os" then
...
response.redirect("../manutencao.asp?strtop=20&tipo=pendentes")





Elseif acao = "2" AND tipo = "modifica_os" Then
...
Elseif acao = "1" AND tipo = "andamento" Then
...
Elseif acao = "2" AND tipo = "andamento" Then
