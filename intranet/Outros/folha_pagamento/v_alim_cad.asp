	...
	<tr>
		<td align="left"-->
			<table cellspacing="1" cellpadding="0" bordercolordark="#FFFFFF" class="table" width="100%" id="print">
					...
					<tr>
						<td colspan="100%">&nbsp;<b>CMI - <font color="red">Vale alimentação</font></b></td>
					</tr>
					<!--tr bgcolor=#cococo>
				...
				<%'*********************************************************
				  ...
				  '************************
					...
					<form action="../../adm_v_alim.asp" name="Ano" method="get">
					<tr>
					...
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td colspan="5">[<a href="adm_v_alim.asp">Mudar Ano</a>] &nbsp;&nbsp; <%=seta_a1%><b><%=ano_sel%></b><%=seta_a1%></td>
					</tr>
					<tr bgcolor=#cococo>
					...
					<form action="../../adm_v_alim.asp" name="mes" method="get">
			...
			<table cellspacing="1" cellpadding="1" border="1"  class="table">
					...
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td colspan="5">[<a href="adm_v_alim.asp">Mudar Ano</a>] &nbsp;&nbsp; [<a href="adm_v_alim.asp?ano_sel=<%=ano_sel%>">Mudar Mês</a>] &nbsp;&nbsp;<b><%=mes_selecionado(mes_sel)%>/<%=ano_sel%></b><%=encerra%></td>
					</tr>
					<tr bgcolor=#cococo>
						<td align=center colspan="100%"><img src="imagens/px.gif" height="0"></td>
					</tr>
					...
					<tr>
						<td colspan="100%">
						<input type="hidden" name="cd_tipo" value="7">
						<input type="hidden" name="cd_mes" value="<%=mes_sel%>">
						<input type="hidden" name="cd_ano" value="<%=ano_sel%>">
						<input type="hidden" name="acao" value="inserir">
						<input type="hidden" name="voltar" value="../adm_v_alim.asp?ano_sel=<%=ano_sel%>&mes_sel=<%=mes_sel%>">
						<input type="submit">
						<input type="reset"></td>
					</tr>
