	...
	<tr>
		<td align="left"-->
			<table cellspacing="1" cellpadding="0" bordercolordark="#FFFFFF" class="table" width="100%" id="print">
					...
					<tr>
						<td colspan="100%">&nbsp;<b>CMI - <font color="red">Adicional noturno</font></b></td>
					</tr>
					<!--tr bgcolor=#cococo>
				...
				<%'*********************************************************
				  ...
				  '************************
					...
					<form action="../../adm_ad_noturno.asp" name="Ano" method="get">
					<tr>
					...
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td colspan="5">[<a href="adm_ad_noturno.asp">Mudar Ano</a>] &nbsp;&nbsp; <%=seta_a1%><b><%=ano_sel%></b><%=seta_a1%></td>
					</tr>
					<tr bgcolor=#cococo>
					...
					<form action="../../adm_ad_noturno.asp" name="mes" method="get">
				...
				<%'*********************************************************
				  ...
				  '***************************
					...
					elseif mes_sel <> "" AND ano_sel <> "" AND cd_codigo = "" Then%>
			<table cellspacing="1" cellpadding="1" border="1"  class="txt_pequeno"><!--table"-->
					<tr bgcolor=#cococo>
						<td align=center colspan="100%"><img src="imagens/px.gif"  height=0></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td colspan="5">[<a href="adm_ad_noturno.asp">Mudar Ano</a>] &nbsp;&nbsp; [<a href="adm_ad_noturno.asp?ano_sel=<%=ano_sel%>">Mudar Mês</a>] &nbsp;&nbsp;<b><%=mes_selecionado(mes_sel)%>/<%=ano_sel%></b><%=encerra%></td>
					</tr>
					<tr bgcolor=#cococo>
						<td align=center colspan="100%"><img src="imagens/px.gif" height="0"></td>
					</tr>
					...
					<tr>
						<td colspan="3">
						<input type="hidden" name="cd_tipo" value="4">
						<input type="hidden" name="cd_mes" value="<%=mes_sel%>">
						<input type="hidden" name="cd_ano" value="<%=ano_sel%>">
						<input type="hidden" name="acao" value="inserir">
						<input type="hidden" name="voltar" value="../adm_ad_noturno.asp?ano_sel=<%=ano_sel%>&mes_sel=<%=mes_sel%>">
						<input type="submit">
						<input type="reset"></td>
						<td>&nbsp;</td>
					</tr>
				...
				<tr bgcolor=#FFFFFF id="no_print"><!--Separador e limitador de espaços-->
						<td colspan="3"><img src="imagens/blackdot.gif" width=100% height=0></td>
						<td>&nbsp;</td>
				</tr>
