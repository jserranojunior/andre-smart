	...
	<tr>
		<td align="left"-->
			<table cellspacing="1" cellpadding="0" bordercolordark="#FFFFFF" class="table" width="100%" id="print">
					...
					<tr>
						<td colspan="100%">&nbsp;<b>CMI - <font color="red">Auxílio Creche</font></b></td>
					</tr>
					<!--tr bgcolor=#cococo>
				...
				<%'*********************************************************
				  ...
				  '************************
					...
					<form action="../../adm_aux_creche.asp" name="Ano" method="get">
					<tr>
					...
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td colspan="5">[<a href="adm_aux_creche.asp.asp">Mudar Ano</a>] &nbsp;&nbsp; <%=seta_a1%><b><%=ano_sel%></b><%=seta_a1%></td>
					</tr>
					<tr bgcolor=#cococo>
					...
					<form action="../../adm_aux_creche.asp" name="mes" method="get">
			...
			<table cellspacing="1" cellpadding="1" border="1"  class="table">
					...
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td colspan="5">[<a href="adm_aux_creche.asp">Mudar Ano</a>] &nbsp;&nbsp; [<a href="adm_aux_creche.asp?ano_sel=<%=ano_sel%>">Mudar Mês</a>] &nbsp;&nbsp;<b><%=mes_selecionado(mes_sel)%>/<%=ano_sel%></b><%=encerra%></td>
					</tr>
					<tr bgcolor=#cococo>
						<td align=center colspan="100%"><img src="imagens/px.gif" height="0"></td>
					</tr>
					...
					<tr>
						<td colspan="100%">
						<input type="hidden" name="cd_tipo" value="5">
