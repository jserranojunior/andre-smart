...
<form action="../adm/adm3_acao.asp" method="post" name="form" onsubmit="return validar_patrimonio(document.form);" onSubmit="return checa(this);">
...
<tr>
    ...
    <td colspan="3"><select name="cd_equipamento" class="inputs" onFocus="nextfield ='cd_marca';">
					...
					<a href="javascript:;" onclick="window.open('adm/equipamento_cad.asp?janela=1', 'principal', 'width=500, height=400'); return false;">+</a>
	</td>
...
<tr>
    <td>&nbsp;</td>
    <td colspan="3"><input type="submit" name="envia" value="OK">&nbsp; <a href="patrimonio_cadastro.asp">Novo</a> &nbsp; <a href="patrimonio_descarte.asp">Descarte</a><br>
...
<tr bgcolor="#C0C0C0">
	<td>Nº</td>
	<td><b><a href="patrimonio_cadastro.asp?ordem=cd_patrimonio">PATRIMÔNIO</b></a></td>
	<td><b><a href="patrimonio_cadastro.asp?ordem=cd_pn">CÓD. PRODUTO</b></a></td>
	<td><b><a href="patrimonio_cadastro.asp?ordem=nm_equipamento">EQUIPAMENTO</b></a></td>
	<td><b><a href="patrimonio_cadastro.asp?ordem=nm_marca">MARCA</b></a></td>
	<td><b><a href="patrimonio_cadastro.asp?ordem=cd_ns">SÉRIE</b></a></td>
	<td><b><a href="patrimonio_cadastro.asp?ordem=nm_unidade">UNIDADE</b></a></td>
	<td><b><a href="patrimonio_cadastro.asp?ordem=dt_data">COMPRA</b></a></td>
	<td id="no_print">&nbsp;</td>
</tr>
<tr>
...
function JsDelete(cod1, cod2, cod3, cod4, cod5, cod6)
{
  if (confirm ("Tem certeza que deseja excluir?"))
	  {
		document.location.href('adm/adm3_acao.asp?cd_apaga='+cod1+'&cd_tipo=patrimonio');
	  }
}
