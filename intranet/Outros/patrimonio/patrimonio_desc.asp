...
<form action="../adm/adm3_acao.asp" method="post">
...
<tr onmouseover="mOvr(this,'#CFC8FF');"   onmouseout="mOut(this,'');">
	...
	<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio_descarte.asp?cd_pat_codigo=<%=cd_pat_codigo%>&acao=editar');" onmouseout="mOut(this,'');">
	<%=cd_patrimonio%></td>
	<!--td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio_descarte.asp?cd_pat_codigo=<%=cd_pat_codigo%>&cd_equipamento=<%=cd_equipamento%>&cd_marca=<%=cd_marca%>&cd_unidade=<%=cd_unidade%>&cd_ns=<%=cd_ns%>&cd_pn=<%=cd_pn%>&cd_patrimonio=<%=cd_patrimonio%>&dt_data=<%=dt_data%>&acao=editar');" onmouseout="mOut(this,'');">
	<%=cd_pn%></td-->
	<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio_descarte.asp?cd_pat_codigo=<%=cd_pat_codigo%>&acao=editar');" onmouseout="mOut(this,'');">
	<%=nm_equipamento%></td>
	<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio_descarte.asp?cd_pat_codigo=<%=cd_pat_codigo%>&acao=editar');" onmouseout="mOut(this,'');">
	...
	<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio_descarte.asp?cd_pat_codigo=<%=cd_pat_codigo%>&acao=editar');" onmouseout="mOut(this,'');">
	<%=zero(day(dt_descarte))%>/<%=zero(month(dt_descarte))%>/<%=year(dt_descarte)%></td>
	<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio_descarte.asp?cd_pat_codigo=<%=cd_pat_codigo%>&acao=editar');" onmouseout="mOut(this,'');">
