...
<tr style="background-color:<%=cor_emprest%>;">
	...
	<td>&nbsp; Data: <input type="text" name="dia_descarte" size="2" maxlength="2" value="<%'=dia_devolucao%>" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);">/<input type="text" name="mes_descarte" size="2" maxlength="2" value="<%'=mes_devolucao%>" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);">/<input type="text" name="ano_descarte" size="4" maxlength="4" value="<%'=ano_devolucao%>"></td>
	<td>&nbsp;Obs.:<br><img src="../../imagens/px.gif" alt="" width="80" height="1" border="0"></td>
	<td><textarea cols="25" rows="1" name="nm_obs"><%'=nm_empr_obs%></textarea>
...
<tr style="background-color:<%=cor_emprest%>;">
	...
	<tr style="background-color:<%=cor_emprest%>;">
		<td>&nbsp;Solicitante:</td>
		<td><input type="text" name="nm_solicitante" value="<%'=nm_solicitante%>" size="30" maxlength="200" onFocus="nextfield ='nm_empr_obs';"></td>
		<td>&nbsp;Obs.:<br><img src="../../imagens/px.gif" alt="" width="80" height="1" border="0"></td>
		<td><textarea cols="25" rows="1" name="nm_empr_obs"><%'=nm_empr_obs%></textarea></td>	
	</tr>
...
<tr style="background-color:<%=cor_emprest%>;">
	<td><img src="../../imagens/px.gif" alt="" width="110" height="1" border="0"><input type="hidden" name="cd_unidade_mov" value="<%=cd_unidade%>"><%'="{"&cd_unidade&"-"&cd_rack&"}{"&cd_unidade2&"-"&cd_rack2&"}"%></td>
	<td>&nbsp; Data: <input type="text" name="dia_estoque" size="2" maxlength="2" value="<%'=dia_devolucao%>" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);">/<input type="text" name="mes_estoque" size="2" maxlength="2" value="<%'=mes_devolucao%>" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);">/<input type="text" name="ano_estoque" size="4" maxlength="4" value="<%'=ano_devolucao%>">
...
<tr style="background-color:<%=cor_emprest%>;">
	...
	<tr style="background-color:<%=cor_emprest%>;">
		...
		<td><input type="text" name="nm_solicitante" value="<%'=nm_solicitante%>" size="34" maxlength="200" onFocus="nextfield ='nm_empr_obs';"></td>
		<td>&nbsp;Obs.:<br><img src="../../imagens/px.gif" alt="" width="80" height="1" border="0"></td>
		<td><textarea cols="22" rows="1" name="nm_empr_obs"><%'=nm_empr_obs%></textarea></td>	
	</tr>
...
<tr>
	<td><img src="../../imagens/px.gif" alt="" width="110" height="1" border="0"><input type="hidden" name="cd_unidade_2" value="<%=cd_unidade2%>"><input type="hidden" name="cd_rack_2" value="<%=cd_rack2%>"></td>
