...
<%if session_cd_usuario = 46 then%>patrimonio_oticas_vdlap.asp<%end if%>
<head>
...
<table align="center" id="no_print" style="border:1 solid blue;">
	...
	<%if session_cd_usuario = 46 then%><tr><td colspan="2" align="center">(patrimonio_oticas_vdlap.asp)</td></tr><%end if%>
