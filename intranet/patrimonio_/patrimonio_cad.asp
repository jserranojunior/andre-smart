...
<%if session("cd_codigo") = 46 then%>
	<tr><td colspan="100" align="center"><span style="font-size=8px;color:red;">patrimonio_cad.asp</span>  - <%=caminho%></td></tr>
<%end if%>
<tr>
...
<%end if
	...
	<tr style="background-color:<%=cor_emprest%>;">
		...
		<td><%if cd_emprestimo <> "" OR cd_cancela <> "1" then%><img src="../imagens/ic_reprovado.gif" alt="Cancela o emprestimo/comodato" width="10" height="12" border="0" onClick="javascript:Jscancela('<%=cd_emprestimo%>')"><%end if%></td>
	</tr>
