...
<form action="patrimonio/acoes/patrimonio_acao.asp" method="post" name="form" onsubmit="return validar_patrimonio(document.form);" onSubmit="return checa(this);">
...
<tr>
    ...
    <td colspan="3"><input type="text" name="cd_patrimonio" value="<%=cd_patrimonio%>" class="inputs" onFocus="nextfield ='nm_tipo';"></td>
</tr>
<tr>
    ...
    <td colspan="3">
		...
		<select name="nm_tipo" onFocus="nextfield ='cd_pn';"  class="inputs">
			<option value=""></option>
...
<tr>
	...
	<td colspan="3"><select name="cd_especialidade" class="inputs" onFocus="nextfield ='cd_marca';">
						<option value=""></option>
...
<tr>
    <td>&nbsp; Data de compra:</td>
					<%if cd_pat_codigo <> "" Then%>
						...
						<%dt_ano = year(dt_data)%>
					<%end if%>
    <td colspan="3"><input type="text" name="cd_dia" size="2" maxlength="2" value="<%=zero(day(dt_data))%>" class="inputs" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);" onFocus="nextfield ='cd_mes';">/
					<input type="text" name="cd_mes" size="2" maxlength="2" value="<%=zero(month(dt_data))%>" class="inputs" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);" onFocus="nextfield ='cd_ano';">/
					<input type="text" name="cd_ano" size="4" maxlength="4" value="<%=year(dt_data)%>" class="inputs" onFocus="nextfield ='done';"></td>
</tr>
<tr>
    <td colspan="4">&nbsp;</td>
</tr>
<tr>
    <td>&nbsp;</td>
    <td colspan="3"><input type="submit" name="envia" value="OK">&nbsp; <a href="patrimonio.asp?tipo=cadastro">Novo</a> &nbsp; <a href="patrimonio.asp?tipo=descarte&cd_pat_codigo=<%=cd_pat_codigo%>">Descarte</a><br>
...
<table>
	...
	<form action="patrimonio.asp?tipo=cadastro" name="Form" id="Form">	
	<tr>
		<td></td>
	</tr>
	</form>
...
<tr bgcolor="#C0C0C0">
	...
	<td><b><a href="patrimonio.asp?tipo=cadastro&ordem=cd_especialidade">&nbsp;ESPECIALIDADE</b></a></td>
...
<tr onmouseover="mOvr(this,'#CFC8FF');"   onmouseout="mOut(this,'');">
	<td align="center" valign="top" bgcolor="#C0C0C0">&nbsp;<b><%=zero(num_lista)%></b></td>
			<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio.asp?tipo=cadastro&cd_pat_codigo=<%=cd_pat_codigo%>&cd_equipamento=<%=cd_equipamento%>&cd_marca=<%=cd_marca%>&cd_unidade=<%=cd_unidade%>&cd_ns=<%=cd_ns%>&cd_pn=<%=cd_pn%>&cd_patrimonio=<%=cd_patrimonio%>&cd_especialidade=<%=cd_especialidade%>&nm_tipo=<%=nm_tipo%>&dt_data=<%=dt_data%>&acao=editar');" onmouseout="mOut(this,'');">&nbsp;<%=nm_tipo%><%=cd_patrimonio%></td>
   			<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio.asp?tipo=cadastro&cd_pat_codigo=<%=cd_pat_codigo%>&cd_equipamento=<%=cd_equipamento%>&cd_marca=<%=cd_marca%>&cd_unidade=<%=cd_unidade%>&cd_ns=<%=cd_ns%>&cd_pn=<%=cd_pn%>&cd_patrimonio=<%=cd_patrimonio%>&cd_especialidade=<%=cd_especialidade%>&nm_tipo=<%=nm_tipo%>&dt_data=<%=dt_data%>&acao=editar');" onmouseout="mOut(this,'');">&nbsp;<%=cd_pn%></td>
			<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio.asp?tipo=cadastro&cd_pat_codigo=<%=cd_pat_codigo%>&cd_equipamento=<%=cd_equipamento%>&cd_marca=<%=cd_marca%>&cd_unidade=<%=cd_unidade%>&cd_ns=<%=cd_ns%>&cd_pn=<%=cd_pn%>&cd_patrimonio=<%=cd_patrimonio%>&cd_especialidade=<%=cd_especialidade%>&nm_tipo=<%=nm_tipo%>&dt_data=<%=dt_data%>&acao=editar');" onmouseout="mOut(this,'');">&nbsp;<%=nm_equipamento%></td>
			<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio.asp?tipo=cadastro&cd_pat_codigo=<%=cd_pat_codigo%>&cd_equipamento=<%=cd_equipamento%>&cd_marca=<%=cd_marca%>&cd_unidade=<%=cd_unidade%>&cd_ns=<%=cd_ns%>&cd_pn=<%=cd_pn%>&cd_patrimonio=<%=cd_patrimonio%>&cd_especialidade=<%=cd_especialidade%>&nm_tipo=<%=nm_tipo%>&dt_data=<%=dt_data%>&acao=editar');" onmouseout="mOut(this,'');">&nbsp;<%=nm_especialidade%></td>
			<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio.asp?tipo=cadastro&cd_pat_codigo=<%=cd_pat_codigo%>&cd_equipamento=<%=cd_equipamento%>&cd_marca=<%=cd_marca%>&cd_unidade=<%=cd_unidade%>&cd_ns=<%=cd_ns%>&cd_pn=<%=cd_pn%>&cd_patrimonio=<%=cd_patrimonio%>&cd_especialidade=<%=cd_especialidade%>&nm_tipo=<%=nm_tipo%>&dt_data=<%=dt_data%>&acao=editar');" onmouseout="mOut(this,'');">&nbsp;<%=nm_marca%></td>
			<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio.asp?tipo=cadastro&cd_pat_codigo=<%=cd_pat_codigo%>&cd_equipamento=<%=cd_equipamento%>&cd_marca=<%=cd_marca%>&cd_unidade=<%=cd_unidade%>&cd_ns=<%=cd_ns%>&cd_pn=<%=cd_pn%>&cd_patrimonio=<%=cd_patrimonio%>&cd_especialidade=<%=cd_especialidade%>&nm_tipo=<%=nm_tipo%>&dt_data=<%=dt_data%>&acao=editar');" onmouseout="mOut(this,'');">&nbsp;<%=cd_ns%></td>
			<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio.asp?tipo=cadastro&cd_pat_codigo=<%=cd_pat_codigo%>&cd_equipamento=<%=cd_equipamento%>&cd_marca=<%=cd_marca%>&cd_unidade=<%=cd_unidade%>&cd_ns=<%=cd_ns%>&cd_pn=<%=cd_pn%>&cd_patrimonio=<%=cd_patrimonio%>&cd_especialidade=<%=cd_especialidade%>&nm_tipo=<%=nm_tipo%>&dt_data=<%=dt_data%>&acao=editar');" onmouseout="mOut(this,'');">&nbsp;<%=nm_sigla%></td>
			<td valign="top" onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:location.replace('patrimonio.asp?tipo=cadastro&cd_pat_codigo=<%=cd_pat_codigo%>&cd_equipamento=<%=cd_equipamento%>&cd_marca=<%=cd_marca%>&cd_unidade=<%=cd_unidade%>&cd_ns=<%=cd_ns%>&cd_pn=<%=cd_pn%>&cd_patrimonio=<%=cd_patrimonio%>&cd_especialidade=<%=cd_especialidade%>&nm_tipo=<%=nm_tipo%>&dt_data=<%=dt_data%>&acao=editar');" onmouseout="mOut(this,'');">&nbsp;<%=zero(day(dt_data))%>/<%=zero(month(dt_data))%>/<%=year(dt_data)%></td>	
...
function JsDelete(cod1, cod2, cod3, cod4, cod5, cod6)
{
  if (confirm ("Tem certeza que deseja excluir?"))
	  {
		document.location.href('patrimonio/acoes/patrimonio_acao.asp?cd_apaga='+cod1+'&cd_tipo=patrimonio');
	  }
}
