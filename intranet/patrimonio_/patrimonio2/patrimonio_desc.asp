...
<form action="patrimonio/acoes/patrimonio_acao.asp" method="post">
...
<tr>
    <td>&nbsp;</td>
    <td colspan="3"><input type="submit" name="ok" value="Descarta"> &nbsp; <a href="patrimonio.asp?tipo=cadastro">Lista/Novo</a><br>
...
<%num_lista = 1
			condicao = "WHERE dt_descarte is not null "
