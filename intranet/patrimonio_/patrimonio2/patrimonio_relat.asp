...
<table align="center">
	<tr>
		<td><B>RELAÇÃO DE EQUIPAMENTOS DIVIDIDOS POR UNIDADE E RACK</B></td>
	</tr>
</table><br>
...
<table class="txt" border="0" width="600" align="center">	
	...
	<%if cabeca = 0 then%>
	<tr>
		<td colspan="100%" align="center"><b>HOSPITAL - <%=nm_unidade%> <br>Relação de Equipamentos  - Videocirurgia<br>Vd Lap<p>&nbsp;</b></p>
		</td></tr>
	<tr bgcolor="#C0C0C0">
		...
		<td align="center"><b>Nº Patrimonio</b></td>
		<td align="center"><b>Nº Hospital</b></td>
	</tr>
	<tr bgcolor="#C0C0C0">
		<td>&nbsp;</td>
		<td>&nbsp;</td>
