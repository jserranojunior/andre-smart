...
<%num_lista = 1
	...
	'*** CONDIÇÕES ***
		if tipo_patr <> "" OR  patrimonio <> "" OR equipamento <> "" OR modelo <> "" OR nserie <> "" OR marca > 0  OR especialidade > 0 OR codhosp <> "" OR rack > 0 OR unidade > 0 OR dia_compra_i <> "" OR dia_compra_f <> ""  OR mes_compra_i <> ""  OR mes_compra_f <> "" OR nao_constar >= 1 Then
