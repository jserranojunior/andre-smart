...
<table class="txt" border="0" width="600" align="center" cellpadding="0" cellspacing="0" bgcolor="#C0C0C0" style="border-collapse:collapse;">
	...
	'rack_anterior = 0
				...
				'strsql = "SELECT * FROM VIEW_patrimonio_lista WHERE cd_unidade_comodato = "&strcd_unidade&" AND nm_tipo = 'E' order by cd_rack, cd_posicao, nm_equipamento_novo"
	...
	'data_agora = day(now)&"/"&month(now)&"/"&year(now)
