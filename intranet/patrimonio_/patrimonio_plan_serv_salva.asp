...
<table id="no_print" style="border:1 solid green; left:150px;" align="center">
	<form action="patrimonio.asp" method="post" name="form">
...
<table class="txt" border="0" width="600" align="center" style="border-collapse:collapse;>	
	...
	<tr>
		...
		<td id="ok_print"><img src="../imagens/px.gif" alt="" width="75" height="5" border="0"></td>	
	...
	<%conteudo = conteudo&"$"&i&";"&strcd_unidade&";"&nm_equipamento&";"&no_patrimonio&";"&nm_marca&";"&cd_pn&";"&dt_periodicidade&";"&mes_servico&";"&ano_sel
	dt_plan_prev_mes = ""
	dt_plan_prev_ano = ""
	meses = ""
	var = ""
	...
	<!--tr id="no_print"><td colspan="100%">&nbsp;</td></tr-->
