...
<table class="no_print" style="border:3 solid <%=str_tb_cor%>; left:150px;" align="center">
	<%if session_cd_usuario = 46 then%><tr><td colspan="2" align="center"><span style="font-size:9px; color:red;">patrimonio_serv_vencimento.asp</span></td></tr><%end if%>
	...
	<tr style="border:1 solid orange; background-color:silver;">
		<td colspan="100%" align="center"><B>LISTAGEM DE MANUTENÇÕES <%=str_titulo%>xxx</B></td>
	</tr>
	<tr>
		<td>&nbsp; Ano:</td>
							...
							<%'if confirmacao = 1 Then
								if not rs_pat.EOF then
									...
									<tr onmouseover="mOvr(this,'#CFC8FF');" onmouseout="mOut(this,'');">
										...
										<td align="center"><%'=cd_patrimonio&"-"%><%'=nm_tipo%><%if len(no_patrimonio) < 3 then%>0<%end if%><%=no_patrimonio%></td>
