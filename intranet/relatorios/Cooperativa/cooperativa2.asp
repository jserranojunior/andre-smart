...
%>		
	...
	<form action="relatorio_coop.asp">
		<tr>
			<td>&nbsp;</td>
			<td colspan="5">[<a href="relatorio_coop.asp">Mudar Ano</a>]  &nbsp;&nbsp;</td>
		</tr>
		<tr bgcolor=#cococo>
			<td align=center colspan="100%"><img src="imagens/px.gif"  height=0></td>
		</tr>
...
'*********************************************************
	...
	End Function
		...
		'*** Lista os registros ***
		xsql = "up_relatorio_cooperativa @mes="&mes&", @ano="&ano&""
		...
		<Table width="<%=largura_col%>" border="0" cellspacing="1" cellpadding="0" class="textopequeno">
		<tr>
		...
		funcao = rs("cd_funcao")
		dt_demissao = int(rs("dt_demissao"))
		...
		<tr>
			...
			<a href="relatorios/cooperativa/cooperativa.asp?mes=<%=mes%>&ano=<%=ano%>&unit=k&relatorio=beneficios" target="blanck">Imprimir - Benefícios em Detalhes</a><br><br>
			</td>
			<td>&nbsp;<br><br><br></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
