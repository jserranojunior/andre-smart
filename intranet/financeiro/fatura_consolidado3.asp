...
<table border="1" class="nok_print" style="border-collapse:collapse">
	<tr bgcolor="#e9e9e9">
	  ...
	  <td align="center" style="font-size:13px; color:red;"><b><%=mes_selecionado(i)%></b><b class="ok_print">/<%=dt_ano%></b><br>
			...
			Set rs = dbconn.execute(xsql)%>
				<%while not rs.EOF
					...
					<tr>
						<td width="20" rowspan="1" align="center" valign="middle"><%=zero(num_linha)%><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
						<td width="50" rowspan="1" align="center" valign="middle"><a href="javascript:void(0);" onClick="window.open('ferramentas/unidade_cad.asp?cd_unidade=<%=strcd_unidade%>&status=1&acao=editar&jan=1','Altera_nome','width=520,height=440,location=0,status=0,scrollbars=1')" return false;"><b><%=strnm_sigla%></b></a><br>
				...
				<tr class="bolder">
				  <td align="center" colspan="2">Total Qtd.</td>
				  <td width="155" align="right"><%if nr_total_mes > 0 then response.write(formatnumber(nr_qtd_total_procs,2))%></td>
				...
				<tr>
					...
					<td colspan="2" align="right"><b><%if nr_total_mes > 0 then response.write(formatnumber(nr_total_mes,2))%></b><img src="../imagens/px.gif" alt="" width="113" height="1" border="0"></td>
				</tr>
				...
				<tr>
					...
					<td colspan="2" align="right"><b><%if total_recebidos_atrasados <> "" then response.write(formatnumber(total_recebidos_atrasados,2))%></b><img src="../imagens/px.gif" alt="" width="100" height="1" border="0"><img src="../imagens/ic_editar.gif" alt="" width="13" height="14" border="0" onClick="window.open('fatura_lista_valores.asp?dt_mes=<%=i%>&dt_ano=<%=dt_ano%>&modo=receb_atraso','lista','location=0,status=0,width=300,height=200,scrollbars=1,resizable=0')"></td>
				</tr>
				...
				<tr>
					...
					<td colspan="2" align="right" style="font-size:11px;"><b>
					
					<%if total_recebido_mes <> "" Then response.write(formatcurrency(total_recebido_mes,2))%></b>
					
					<img src="../imagens/px.gif" alt="" width="115" height="1" border="0"></td>
			...
			<!--td style="page-break-after:always;"><img src="../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
			</tr-->
			<!--tr-->
			<%end if%>
