...
<%if cd_unidade <> 0 Then%>
	...
	<%if cd_unidade = "0" OR cd_unidade = "" Then
		...
		'	*** Cálculo para vencimento de pagamento ***
			...
			Set rs_pref = dbconn.execute(xsql)
				...
				if cd_unidade = 2 then
					'nm_dia_vencimento1 = "19"
					'dt_mes = 12
				end if
				%>
			...
			<table align="center" width="500" border="0" style="border-collapse:collapse;">
				...
				<tr>
					...
					<td colspan="2" valign="top" style="font-family:arial; font-size:18px; text-align:justify; text-justify:inter-word;">
						<%if cd_valor_fixo = 1 then%>
							Recebi da <b><%=nm_empresa%></b>, o recibo de pagamento da locação dos equipamentos de videocirurgia relativo ao mesmo mês com vencimento em <b><%=nm_dia_vencimento1%> <%if nm_dia_vencimento2 <> "" Then response.write(" e "&nm_dia_vencimento2)%> de <%=mes_selecionado(dt_mes)&" de "&dt_ano%></b><%=complemento%>.
						<%else%>
							Recebi da <b><%=nm_empresa%></b>, o relatório dos procedimentos realizados por videocirurgia no mês de <%=mes_selecionado(mes_procedimentos)&" de "&ano_procedimentos%>, no <b><%=nm_unidade_nome%></b>, junto com o recibo de pagamento da locação dos equipamentos de videocirurgia relativo ao mês com vencimento em <b><%=nm_dia_vencimento1%> <%if nm_dia_vencimento2 <> "" Then response.write(" e "&nm_dia_vencimento2)%> de <%=mes_selecionado(dt_mes)&" de "&dt_ano%></b><%=complemento%>.
						<%end if%></td>
				</tr>
	...
	**************************************************-->
			...
			<table width="650" align="center" border="0">
				...
				<tr>
					<td>&nbsp;<!-- limitador de linha --></td>
					<td colspan="1" style="font-family:arial; font-size:15px;">São Paulo, <%="05 de "&mes_selecionado(dt_mes)&" de "&dt_ano%>.</td>
				...
				<tr>
					<td>&nbsp;<!-- limitador de linha --></td>
					<td colspan="1" style="font-family:arial; font-size:15px;"><b>À<br>Rede D´Or São Luiz<%'=nm_unidade_nome%><br>&nbsp;<br>A/C: <%=nm_contato%></b></td>
				</tr>
				<tr><td colspan="2"><img src="../imagens/px.gif" alt="" width="1" height="50" border="0"></td></tr>
				<tr>
					<td>&nbsp;<!-- limitador de linha --></td>
				...
				<tr>
					...
					<td colspan="2" valign="top" style="font-family:arial; font-size:16px; text-align:justify; text-justify:inter-word;" >
						Em contrato firmado, informamos o número de procedimentos realizados no centro cirurgico do hospital São Luiz Rede D´Or <%'=nm_unidade_nome%> no período de 01 a <%=ultimodiames(mes_procedimentos,ano_procedimentos)&" de "&mes_selecionado(mes_procedimentos)&" de "&ano_procedimentos%>, nas unidades Itaim, Morumbi, Anália Franco e Jabaquara<%'=complemento%>.<br>
						...
						<img src="../imagens/px.gif" alt="" width="1" height="40" border="0"><br>
										...
										qtd_linha_procs = qtd_linha_procs + 1
											...
											<tr>
												...
												<!--td align="center" style="padding:15px 5px;">
													...
													<td align="center" style="padding:15px 5px;">&nbsp;<%'=formatnumber(nm_total_unidade)%> R$ 541.940,00</td>
											</tr>
								<%cab = cab + 1
								nm_qtd_procedimentos = ""
								nm_qtd_empr = ""
								...
								<tr>
									...
									<td align="center" colspan="3" style="padding:15px 5px;">
									1ª parcela 1/2 - Venc.: 12/03/2015 - valor: R$ 241.940,00<br><br>
									
									2ª parcela 2/2 - Venc.: 23/03/2015 - valor: R$ 300.000,00<br>
									</td>
								</tr>
							</table>
	...
	*****************************************-->
			...
			<table width="500" border="0" align="center" style="border-collapse:collapse;">
				...
				<tr>
					<td>&nbsp;<!-- limitador de linha --></td>
					<td colspan="2" style="font-family:arial; font-size:15px; text-align:right;">São Paulo, <%=zero(nm_dia_vencimento1)&" de "&mes_selecionado(dt_mes)&" de "&dt_ano%>.</td>
				</tr>
				<tr>
