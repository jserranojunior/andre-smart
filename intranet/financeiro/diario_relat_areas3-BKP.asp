...
pre_selecao = " SUM(dbo.TBL_financeiro_valores3.nm_valor) AS pre_total "
'pre_selecao = " dbo.TBL_financeiro_valores3.cd_codigo, dbo.TBL_financeiro_valores3.cd_diario, dbo.TBL_financeiro_valores3.nm_pagamento, dbo.TBL_financeiro_valores3.nm_valor, dbo.TBL_financeiro_valores3.cd_parcela, dbo.TBL_fornecedor.nm_fornecedor, dbo.TBL_financeiro_valores3.cd_pagto_agendado, dbo.TBL_financeiro_valores3.cd_conta_banco, dbo.TBL_financeiro_banco.cd_empresa, dbo.TBL_financeiro_banco.cd_banco, dbo.TBL_financeiro_banco.nm_banco, dbo.TBL_financeiro_banco.cd_agencia, dbo.TBL_financeiro_banco.cd_conta_corrente, dbo.TBL_financeiro_banco.cd_status, dbo.TBL_empresa.nm_empresa, dbo.TBL_empresa.nm_empresa_abrv, dbo.TBL_financeiro_valores3.cd_cheque, dbo.TBL_financeiro_valores3.cd_modo_pagto, dbo.TBL_financeiro_valores3.nm_obs, dbo.TBL_financeiro_valores3.cd_suspenso, dbo.TBL_financeiro_diario3.dt_inicial, dbo.TBL_financeiro_diario3.dt_final, dbo.TBL_financeiro_diario3.nm_descricao, dbo.TBL_financeiro_diario3.cd_fornecedor, dbo.TBL_financeiro_diario3.cd_tipo_valor, dbo.TBL_financeiro_diario3.cd_area, dbo.TBL_financeiro_diario3.nm_nf, dbo.TBL_financeiro_area.nm_area, dbo.TBL_financeiro_diario3.cd_centrocusto, dbo.TBL_financeiro_centrocusto.nm_centrocusto, dbo.TBL_financeiro_centrocusto.nm_cc, dbo.TBL_financeiro_diario3.cd_unidade, dbo.TBL_unidades.nm_unidade, dbo.TBL_unidades.nm_sigla, dbo.TBL_financeiro_conta.nm_conta, dbo.TBL_financeiro_diario3.cd_conta, dbo.TBL_financeiro_conta.nm_conta_abrv, dbo.TBL_financeiro_diario3.pre_ordem, dbo.TBL_financeiro_diario3.cd_qtd_parcelas, dbo.TBL_financeiro_banco_pagamentos3.cd_modo_pagamento, dbo.TBL_financeiro_valores3.dt_vencimento, dbo.TBL_financeiro_banco_pagamentos3.dt_pagamento, dbo.TBL_financeiro_banco_pagamentos3.cd_confirma_pagto,dbo.TBL_financeiro_banco_pagamentos3.cd_pagamento_agendado, dbo.TBL_financeiro_banco_pagamentos3.nm_cheque, dbo.TBL_financeiro_tipo_pagamento.nm_tipo_pagamento, dbo.TBL_financeiro_tipo_pagamento.nm_tipo_pag_abrv "
'******************************************************************
'selecao = " SELECT dbo.TBL_financeiro_valores3.cd_codigo, dbo.TBL_financeiro_valores3.cd_diario, dbo.TBL_financeiro_valores3.nm_valor, dbo.TBL_fornecedor.nm_fornecedor, dbo.TBL_financeiro_valores3.nm_pagamento, dbo.TBL_financeiro_valores3.dt_vencimento, dbo.TBL_financeiro_valores3.cd_parcela, dbo.TBL_financeiro_diario3.cd_qtd_parcelas, "&campos&" "
selecao = " dbo.TBL_financeiro_valores3.cd_codigo, dbo.TBL_financeiro_valores3.cd_diario, dbo.TBL_financeiro_valores3.nm_pagamento, dbo.TBL_financeiro_valores3.nm_valor, dbo.TBL_financeiro_valores3.cd_parcela, dbo.TBL_fornecedor.nm_fornecedor, dbo.TBL_financeiro_valores3.cd_pagto_agendado, dbo.TBL_financeiro_valores3.cd_conta_banco, dbo.TBL_financeiro_banco.cd_empresa, dbo.TBL_financeiro_banco.cd_banco, dbo.TBL_financeiro_banco.nm_banco, dbo.TBL_financeiro_banco.cd_agencia, dbo.TBL_financeiro_banco.cd_conta_corrente, dbo.TBL_financeiro_banco.cd_status, dbo.TBL_empresa.nm_empresa, dbo.TBL_empresa.nm_empresa_abrv, dbo.TBL_financeiro_valores3.cd_cheque, dbo.TBL_financeiro_valores3.cd_modo_pagto, dbo.TBL_financeiro_valores3.nm_obs, dbo.TBL_financeiro_valores3.cd_suspenso, dbo.TBL_financeiro_diario3.dt_inicial, dbo.TBL_financeiro_diario3.dt_final, dbo.TBL_financeiro_diario3.nm_descricao, dbo.TBL_financeiro_diario3.cd_fornecedor, dbo.TBL_financeiro_diario3.cd_tipo_valor, dbo.TBL_financeiro_diario3.cd_area, dbo.TBL_financeiro_diario3.nm_nf, dbo.TBL_financeiro_area.nm_area, dbo.TBL_financeiro_diario3.cd_centrocusto, dbo.TBL_financeiro_centrocusto.nm_centrocusto, dbo.TBL_financeiro_centrocusto.nm_cc, dbo.TBL_financeiro_diario3.cd_unidade, dbo.TBL_unidades.nm_unidade, dbo.TBL_unidades.nm_sigla, dbo.TBL_financeiro_conta.nm_conta, dbo.TBL_financeiro_diario3.cd_conta, dbo.TBL_financeiro_conta.nm_conta_abrv, dbo.TBL_financeiro_diario3.pre_ordem, dbo.TBL_financeiro_diario3.cd_qtd_parcelas, dbo.TBL_financeiro_banco_pagamentos3.cd_modo_pagamento, dbo.TBL_financeiro_valores3.dt_vencimento, dbo.TBL_financeiro_banco_pagamentos3.dt_pagamento, dbo.TBL_financeiro_banco_pagamentos3.cd_confirma_pagto,dbo.TBL_financeiro_banco_pagamentos3.cd_pagamento_agendado, dbo.TBL_financeiro_banco_pagamentos3.nm_cheque, dbo.TBL_financeiro_tipo_pagamento.nm_tipo_pagamento, dbo.TBL_financeiro_tipo_pagamento.nm_tipo_pag_abrv "
'******************************************************************

cond = " WHERE dbo.TBL_financeiro_diario3.cd_qtd_parcelas >= 1 "	
cond_area = " AND dbo.TBL_financeiro_diario3.cd_area = "&cd_area&""
cond_centrocusto = " AND dbo.TBL_financeiro_diario3.cd_centrocusto = "&cd_centrocusto&""
cond_conta = " AND dbo.TBL_financeiro_diario3.cd_conta = "&cd_conta&""
...
condicoes = cond&" "&cond_area&" "&cond_centrocusto&" "&cond_conta&" "&cond_unidade&" "&cond_tipo_valor&" "&cond_periodo&" "&cond_fornecedor&" "&cond_pagamento&" "&cond_modo_pagto&" "&cond_cheque&" "&cond_datacheque'&" "'
...
'***** AGRUPAMENTO ************************************************
    ...
    agrupamento = " GROUP BY dbo.TBL_financeiro_valores3.cd_codigo, dbo.TBL_financeiro_valores3.cd_diario,dbo.TBL_financeiro_valores3.nm_valor,dbo.TBL_fornecedor.nm_fornecedor,dbo.TBL_financeiro_valores3.nm_pagamento,dbo.TBL_financeiro_valores3.dt_vencimento,dbo.TBL_financeiro_valores3.cd_parcela,dbo.TBL_financeiro_diario3.cd_qtd_parcelas,dbo.TBL_financeiro_diario3.cd_area,"&campos&" "
'****************************************************
...
response.write(cd_unidade)

If cd_unidade = "0" Then
	cond_unidade = " AND cd_unidade <> 0 "
End if
...
<%if campo_1 <> 0 Then%><%n_colunas = n_colunas +1%><td align="center">&nbsp;Valor</td><%end if%>
				...
				<tr><td colspan="10" class="ok_print"><img src="imagens/blackdot.gif" alt="" width="100%" height="1"></td></tr>
<%x = "10"
IF x = "10" then
            ...
            xsql = "up_financeiro_pagamento_select @selecao='"&pre_selecao&"', @condicoes='"&condicoes&"', @agrupamento=''"' , &cond&" "&cond_area&" "&cond_centrocusto&" "&cond_conta&" "&cond_unidade&" "&cond_tipo_valor&" "&cond_periodo&" "&cond_fornecedor&" "&cond_pagamento&" "&cond_modo_pagto&" "&cond_cheque&" "&cond_datacheque&" "'
			Set rs = dbconn.execute(xsql)
            while not rs.EOF
'			    pre_total = rs("pre_total")
            ...
            xsql = "up_financeiro_pagamento_select @selecao='"&selecao&"', @condicoes='"&condicoes&"', @agrupamento='"&agrupamento&"'" '""&selecao&" FROM VIEW_financeiro_valores3 "&cond&" "&cond_area&" "&cond_centrocusto&" "&cond_conta&" "&cond_unidade&" "&cond_tipo_valor&" "&cond_periodo&" "&cond_fornecedor&" "&cond_pagamento&" "&cond_modo_pagto&" "&cond_cheque&" "&cond_datacheque&" "&agrupamento&" "&ordem&""'
			Set rs = dbconn.execute(xsql)
            While Not rs.EOF 
...
'			cd_parcela = rs("cd_parcela")
            ...
            %>
				...
				if compara1 <> grava_info AND sub_total_valor > 0 AND subtotais <> "" then%>
					...
					<tr><td colspan="<%=n_colunas+1%>"><img src="../imagens/blackdot.gif" alt="" width="100%" height="1" border="0"></td></tr>
				<%sub_total_valor = 0
				end if%>
			...
			<tr><td colspan="<%=n_colunas+1%>"><img src="imagens/blackdot.gif" width="100%" height="1"></td></tr>					
		...
		<%End if%>
                <!--tr><td><%=selecao%>
                         <br />---<br />
                         FROM            dbo.TBL_financeiro_valores3 LEFT OUTER JOIN
                         dbo.TBL_financeiro_banco_pagamentos3 ON dbo.TBL_financeiro_valores3.cd_cheque = dbo.TBL_financeiro_banco_pagamentos3.cd_codigo LEFT OUTER JOIN
                         dbo.TBL_empresa RIGHT OUTER JOIN
                         dbo.TBL_financeiro_banco ON dbo.TBL_empresa.cd_codigo = dbo.TBL_financeiro_banco.cd_empresa ON 
                         dbo.TBL_financeiro_valores3.cd_conta_banco = dbo.TBL_financeiro_banco.cd_codigo RIGHT OUTER JOIN
                         dbo.TBL_fornecedor RIGHT OUTER JOIN
                         dbo.TBL_financeiro_area RIGHT OUTER JOIN
                         dbo.TBL_financeiro_centrocusto RIGHT OUTER JOIN
                         dbo.TBL_financeiro_conta RIGHT OUTER JOIN
                         dbo.TBL_financeiro_diario3 LEFT OUTER JOIN
                         dbo.TBL_financeiro_tipo_pagamento ON dbo.TBL_financeiro_diario3.cd_tipo_valor = dbo.TBL_financeiro_tipo_pagamento.cd_codigo LEFT OUTER JOIN
                         dbo.TBL_unidades ON dbo.TBL_financeiro_diario3.cd_unidade = dbo.TBL_unidades.cd_codigo ON 
                         dbo.TBL_financeiro_conta.cd_codigo = dbo.TBL_financeiro_diario3.cd_conta ON 
                         dbo.TBL_financeiro_centrocusto.cd_codigo = dbo.TBL_financeiro_diario3.cd_centrocusto ON 
                         dbo.TBL_financeiro_area.cd_codigo = dbo.TBL_financeiro_diario3.cd_area ON dbo.TBL_fornecedor.cd_codigo = dbo.TBL_financeiro_diario3.cd_fornecedor ON 
                         dbo.TBL_financeiro_valores3.cd_diario = dbo.TBL_financeiro_diario3.cd_codigo
                         <br />---<br />
                         WHERE cd_qtd_parcelas >= 1  AND dt_vencimento BETWEEN '<%=data_i%>' AND '<%=data_f%>'
                         <br />----<br />
