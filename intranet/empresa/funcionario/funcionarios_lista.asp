...
if x = 1 then					
							...
							if func_ativos <> "2" then
								...
								'*** TRANSPORTE ***
								xsql = "Select * From View_funcionario_beneficios Where cd_funcionario="&cd_funcionario&" AND cd_beneficio_tipo=2 ORDER BY nm_nome asc"
								...
								IF mostrar_linha = 1 Then 'inibe a linha desejada%>
									...
									<tr onmouseover="mOvr(this,'#CFC8FF');" onmouseout="mOut(this,'<%=cor_linha%>');" style="height:20px; color:<%=cor_registro%>;" bgcolor="<%=cor_linha%>">
										...
										<%if campo_dependentes <> 0 Then%><td valign="top">
											<%'*** DEPENDENTES ***
											xsql = "Select * From VIEW_dependentes Where cd_funcionario = "&cd_funcionario&" ORDER BY nm_nome asc"
										...
										<%if campo_contatos <> 0 Then%><td valign="top">
											...
											xsql = "Select * From VIEW_contatos Where id_origem = "&cd_funcionario&" ORDER BY nm_nome asc"
