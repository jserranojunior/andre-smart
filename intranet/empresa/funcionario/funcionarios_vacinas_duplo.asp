...
<table align="center" width="40">
	...
	<input type="hidden" name="tipo" value="dupla_venc">
	<tr>
			...
			Set rs_func = dbconn.execute(xsql)
				...
				while not rs_func.EOF
					...
					'*** Mostra o cabeçalho ****
						...
						if cabeca_ativo = 0 Then%>
							<tr><td colspan="100%" align="center" style="background-color:gray; color:white; font-size:14px;"><b>VACINAÇÃO - Dupla adulto</b></td></tr>
						<%end if%>
							
							<%if cabeca_exam = 0 AND isnull(val_vac) Then%>
								<tr><td align="center" colspan="9" style="color:white;" bgcolor="#808080"><span style="color:#ff0000;font-size:12px;"><<<</span> Vacinas não preenchidas <span style="color:#ff0000;">>>></span></td></tr>
							<%cabeca_exam = 1
							cabeca_exam1 = 0
							cor_val = "#000000"
							conta_vazios = 0
							...
							elseif cabeca_exam = 1 AND val_vac > -120 Then%>
								<tr><td align="center" colspan="9" style="color:white;" bgcolor="#808080"><span style="color:#ff0000;font-size:12px;"><<<</span> Vacinas já vencidos <span style="color:#ff0000;">>>></span></td></tr>
							<%cabeca_exam = 2
							cabeca_exam1 = 0
							cor_val = "#ff0000"
							conta_vencidos = 0
							...
							elseif cabeca_exam = 2 AND val_vac > 0 Then%>
								<tr><td align="center" colspan="9" style="color:white;" bgcolor="#808080"><span style="color:#fa9814;font-size:12px;"><<<</span> Vacinas vencendo <span style="color:#fa9814;">>>></span></td></tr>
							<%cabeca_exam = 3
							cabeca_exam1 = 0
							cor_val = "#c18509"
							conta_vencendo = 0
							...
							elseif cabeca_exam = 3 AND val_vac > 3 Then%>
								<tr><td align="center" colspan="9" style="color:white;" bgcolor="#808080"><span style="color:#00ff40;font-size:12px;"><<<</span> Vacinas OK <span style="color:#00ff40;">>>></span></td></tr>
							<%cabeca_exam = 4
							cabeca_exam1 = 0
							cor_val = "#000000"
							conta_ok = 0
							...
							<tr bgcolor=#c0c0c0>
								...
								<td align="center"><b>Funcionário</b><br><img src="../../imagens/px.gif" alt="" width="220" height="1" border="0"></td>
								<td align="center"><b>Unidade</b><br><img src="../../imagens/px.gif" alt="" width="65" height="1" border="0"></td>
								<td align="center">1ª<br><img src="../../imagens/px.gif" alt="" width="15" height="1" border="0"></td>
								<td align="center">2ª<br><img src="../../imagens/px.gif" alt="" width="15" height="1" border="0"></td>
								<td align="center">3ª<br><img src="../../imagens/px.gif" alt="" width="15" height="1" border="0"></td>
								<td align="center"><b>Validade</b><br><img src="../../imagens/px.gif" alt="" width="80" height="1" border="0"></td>											
								<td align="center"><b>Tempo</b><br><img src="../../imagens/px.gif" alt="" width="70" height="1" border="0"></td>
							</tr>
							<%cabeca_exam1 = 1
							end if%>
				...
				conta_func = conta_func + 1	%>
					...
					<!-- tr onmouseover="mOvr(this,'#CFC8FF');" onclick="javascript:location.replace('empresa.asp?tipo=cadastro&pag=<%=strpag%>&cod=<%=rs_func("cd_funcionario")%>&busca=<%=strbusca%>');" onmouseout="mOut(this,'<%=cor_linha%>');" style="height:20px;" bgcolor="<%=cor_linha%>"-->
						...
						<td valign="top" align="center"><%=dt_dupla_adulto_val%></td>						
