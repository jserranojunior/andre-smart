...
<%end if%>					
			...
			<!-- ---------------------------------------------------------------- -->				
							...
							<tr style="background-color:gray; color:white;">
								...
								<td align="center"><b>Funcion&aacute;rio</b><br><img src="../../imagens/px.gif" alt="" width="245" height="1" border="0"></td>
								...
								<%'if strtipo <> "var_enf" then%>
									<td align="center"><b>VR</b><br><img src="../../imagens/px.gif" alt="" width="40" height="1" border="0"></td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
					...
					<%if int(strcd_unidade) = "0" OR int(cd_unidade) = int(strcd_unidade) then
							...
							if total_vr > 0 then tt_nr_valor_total_refeic = tt_nr_valor_total_refeic + nr_valor_total
							'if nr_vr_extra > 0 then tt_nr_valor_total_refeic = tt_nr_valor_total_refeic + nr_valor_total
					...
					<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td-->
								<td align="center"><%if nr_vr >= 1 then%><%=int(nr_vr)%><%else%>0<%end if%></td>
								<td align="center"><%if nr_vr_extra >= 1 then%><%=int(nr_vr_extra)%><%else%>0<%end if%></td>
					<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
								<td align="center"><%if total_vr >= 1 then%><%=int(total_vr)%><%else%>0<%end if%></td>
					<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
								<td align="right"><%'=cd_beneficio_transp%><%'if nr_valor >= 1 then%><%'=formatnumber(nr_valor,2)%><%'else%><%if nr_valor_total > 0 then%><%=formatnumber(custo_vr,2)%><%else%>0<%end if%></td>
					<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
								<td align="right"><%'=nr_valor_total_sptrans%><%if nr_valor_total >= 1 then%><%=formatnumber(nr_valor_total,2)%><%else%>0<%end if%><%'=tt_nr_valor_total_refeic%></td>
				</tr>
						<%num_funcionario = num_funcionario + 1
							...
							<tr>
								...
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
								<%'if strtipo <> "var_enf" then%><td align="center"><b><%=tt_vr%></b></td><%'end if%>
								...
								<td colspan="1">&nbsp;</td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
								<td colspan="2" style="font-size:14px;">&nbsp;<b><%if tt_nr_valor_total_refeic <> "" Then%><%=formatnumber(tt_nr_valor_total_refeic,2)%><%else%>0<%end if%></b></td>
								
							</tr>
							<tr><td colspan="14">&nbsp;</td></tr>
							<tr><td colspan="14">&nbsp;** expediente de 6h não recebe vale refeição.</td></tr>
						</table>
