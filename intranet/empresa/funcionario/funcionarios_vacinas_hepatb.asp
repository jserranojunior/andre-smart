...
'*** ORDEM ***
	...
	'ordem_funcionarios = "nr_hepatite_b, nm_nome,dt_admissao"
	ordem_funcionarios = "nr_hepatite_b, nm_nome,dt_admissao"
...
<table align="center" width="40">
	...
	<input type="hidden" name="tipo" value="hepatb_vacina">
	<tr>
	...
	<tr><td>&nbsp;</td></tr>
		...
		'if cd_situacao = 1 OR cd_situacao = "" then
			...
			'xsql = "up_funcionario_contrato_lista @dt_data='"&dt_data&"', @dt_atualizacao='"&month(data_selecionada)&"/"&day(data_selecionada)&"/"&year(data_selecionada)&"', @ordem_funcionarios='"&ordem_funcionarios&"'"
					...
					'*** Mostra o cabeçalho ****
						...
						<%cabeca_ativo = 1
							...
							<tr bgcolor=#c0c0c0>
								...
								<td align="center">1ª<br><img src="../../imagens/px.gif" alt="" width="25" height="1" border="0"></td>
								<td align="center">2ª<br><img src="../../imagens/px.gif" alt="" width="25" height="1" border="0"></td>
								<td align="center">3ª<br><img src="../../imagens/px.gif" alt="" width="25" height="1" border="0"></td>
							</tr>
							<%cabeca_exam1 = 1
							end if%>
