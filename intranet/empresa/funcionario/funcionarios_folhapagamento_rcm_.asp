...
<script language="javascript">
	...
	<%'if str_ok = "Visualizar" then%>
			...
			<!-- ---------------------------------------------------------------- -->				
					...
					<%num_cor = 1
					num_funcionario = 1
					'outras_variaveis = " AND cd_contrato = 1 AND cd_unidade <> 27 "
					'outras_variaveis = "  AND cd_unidade <> 27 "
					'subtotal_he_limit = 0
					...
					xsql = "up_funcionario_contrato_lista3 @dt_data_i='"&mes_ant&"/21/"&ano_ant&"', @dt_data_f='"&mes_competencia&"/"&final_competencia&"/"&ano_competencia&"', @dt_atualizacao = '"&dt_mes&"/"&dia_final&"/"&dt_ano&"', @ordem_funcionarios='"&nm_ordem&"', @outras_variaveis='"&outras_variaveis&"'"
