...
<%qtd_dias_dsr = qtd_domingos_comp + qtd_feriados%>
					...
					<table border="1" cellspacing="0" cellpadding="2" align="center" width="100" class="no_print">
						...
						<form name="data" action="empresa.asp"  method="POST">
							...
							<tr>
								<td colspan="4" align="center" class="cabecalho" style="background-color:black; color:white;"><%'=data_atual%> <b>BENEF&Iacute;CIOS - <%=tit_doc%></b></td>
			...
			<!-- ---------------------------------------------------------------- -->				
							...
							<tr bgcolor="#000000">
								<td colspan="100%" align="center" class="cabecalho" style="background-color:black; color:white;"><b>Relatório Mensal - Transporte<br><%=mesdoano(dt_mes)%>/<%=dt_ano%></b></td>
								<!--td colspan="2" rowspan="4" align="center"><img src="foto/funcionarios/Vdlap.gif" alt="" name="Vdlap.gif" id="Vdlap.gif" width="73" border="0"></td-->
							</tr>
							<tr style="background-color:gray; color:white;">
								...
								<td align="center"><b>Unidade</b><br><img src="../../imagens/px.gif" alt="" width="40" height="1" border="0"></td>
									<td align="center"><b>Qtd. dias</b><br><img src="../../imagens/px.gif" alt="" width="40" height="1" border="0"></td>
					...
					<!-- *** Qtd. Adicional Noturno *** -->
								<!--td align="right">&nbsp;<%if qtd_dia_noturno > 0 then%><%=zero(qtd_dia_noturno)%><%else%>0<%end if%></td>
					<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td-->
					<!-- *** Qtd Hora Extra *** -->
								...
								wend
									...
									array_beneficio = mid(array_beneficio,2,len(array_beneficio))
											...
											str_fornecedor = mid(beneficio_junto,separador,len(beneficio_junto))
												str_fornecedor = replace(str_fornecedor,":","")
													...
													if not rs_val.EOF then
														...
														valor_total = valor_diario * qtd_plantoes
										...
										<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
											...
											<td align="right"><%if valor_total <> "" Then response.write(formatnumber(valor_total,2))%> </td>
										<%
										next
					...
					<!-- *** Total Liquido *** -->	
							...
							'total_liquido = total_liquido + auxcreche%>
								...
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									<td align="right"><b><%if valor_total_mes <> "" Then response.write(formatnumber(valor_total_mes,2))%></b></td>
							</tr>
						<%num_funcionario = num_funcionario + 1
							...
							<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
								...
								<%'if strtipo <> "var_enf" then%><td align="right"><b><%=tt_vt%></b></td><%'end if%>
									...
									<td align="right">&nbsp;<b><%=tt_vt+tt_vt_extra%></b></td>
