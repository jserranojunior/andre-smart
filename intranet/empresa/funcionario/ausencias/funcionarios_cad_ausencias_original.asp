...
<!--#include file="../../../includes/arquivo_loc.asp"-->
					...
					<br>
						<table border="0" cellspacing="0" cellpadding="2" align="center"><!-- OK 2-->
									...
									<form name="Form" action="empresa/funcionario/ausencias/acoes/ausencias_acao.asp"  method="POST"  onsubmit="return validar_ausencia(document.Form);">
									...
									<%if strfoto = "" then%><%strfoto = "Vdlap.gif"%><%end if%>
										...
										<tr>
											<td class="no_print" style="background-color:silver; color:white;"><b>Matrícula</b></td>
											<td class="no_print" style="background-color:silver; color:white;" colspan="2"><b>Empresa</b></td>
										</tr>
										<tr class="no_print">
										...
										<tr>
											...
											<td rowspan="6" align="left" valign="top" class="ok_print"><img src="foto/funcionarios/<%=strfoto%>" alt="" name="<%=strfoto%>" id="<%=strfoto%>" width="73" border="0"></td>
										...
										<tr class="no_print"><td colspan="4"><b></b></td></tr>
										...
										<tr>
											<td valign="top"><input type="text" name="dt_dia" size="3" maxlength="2" onKeyUp="preenche_dia();" value="<%=zero(dia_sel)%>" onKeyPress="ChecarTAB();" onKeydown="Mostra(this, 2)" onFocus="PararTAB(this);">/
															<input type="text" name="dt_mes" size="3" maxlength="2" onKeyUp="preenche_mes();" value="<%=zero(mes_sel)%>" onKeyPress="ChecarTAB();" onKeydown="Mostra(this, 2)" onFocus="PararTAB(this);">/
								...
								<table align="center" border="1">
									<tr>
										<td colspan="5">Selecione o período</td>
									</tr>
									<form action="../../../empresa.asp" method="post" name="form" id="form">
									<input type="hidden" name="tipo" value="cad_ausencia">
									<input type="hidden" name="cod" value="<%=str_funcionario%>">
									<tr>	
										<td colspan="2"><select name="mes_sel">
												<%for i = 1 to 12%>
													<option value="<%=i%>" <%if int(mes_sel) = i then%>SELECTED<%end if%>><%=mesdoano(i)%></option>													
												<%next%>
										</select></td>
										<td><input type="text" name="ano_sel" size="4" maxlength="4" value="<%=ano_sel%>"></td>
										<td><input type="submit" value="Seleciona"></td>
									</tr>
									</form>
									<tr>
										<td colspan="7" align="center" style="background-color:gray; color:white;">Quantidade de ausencias no mês atual</td>
									</tr>
									...
									strsql ="SELECT * From TBL_funcionario_ausencias where cd_funcionario = "&str_funcionario&" AND month(dt_afastamento_i) = "&mes_sel&" AND year(dt_afastamento_i) = "&ano_sel&" order by dt_ausencia"
