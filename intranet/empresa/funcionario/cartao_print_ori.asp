...
if mes_sel = "" AND ano_sel = "" Then%>
				<table border="0" align="center" style="border:1 solid black;" class="no_print">
					...
					<tr>
					    <td colspan="100%" align="center">Selecione o período da listagem:</td>
					</tr>
					<tr bgcolor=#cococo>
						<td align=center colspan="100%"><img src="imagens/px.gif"  height=1></td>
					</tr>
					...
					<tr>
						...
						<td align="left" style="color:gray;"><input type="text" name="dia_sel" size="2" maxlength="2" value="<%=zero(dia_sel)%>" onMouseup="limpa_dia()">
