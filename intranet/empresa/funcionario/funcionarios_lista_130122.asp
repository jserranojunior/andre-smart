...
<table align="center">
	...
	<tr>
					...
					if func_ativos = "" OR func_ativos = 1 Then
						...
						'xsql = "SELECT *FROM TBL_funcionario Where dt_admissao_geral >='"&mes_sel&"/1/"&ano_sel&"' AND dt_demissao_geral >='"&mes_sel&"/"&dia_final&"/"&ano_sel&"' OR dt_admissao_geral <='"&mes_sel&"/1/"&ano_sel&"' AND dt_demissao_geral is NULL order by nm_nome"
						'xsql = "SELECT *FROM VIEW_funcionario_contrato_lista2 Where dt_admissao_geral >='"&mes_sel&"/1/"&ano_sel&"' AND dt_demissao_geral >='"&mes_sel&"/"&dia_final&"/"&ano_sel&"' OR dt_admissao_geral <='"&mes_sel&"/1/"&ano_sel&"' AND dt_demissao_geral is NULL order by nm_nome"
						'xsql = "up_funcionario_contrato_lista3 @dt_data_i='"&mes_sel&"/1/"&ano_sel&"', @dt_data_f='"&mes_sel&"/"&dia_final&"/"&ano_sel&"', @dt_atualizacao = '"&mes_sel&"/"&dia_final&"/"&ano_sel&"', @ordem_funcionarios='"&ordem_funcionarios&"', @outras_variaveis='"&outras_variaveis_&"'"
						'xsql = "up_funcionario_contrato_lista3 @dt_data_i='"&mes_sel&"/1/"&ano_sel&"', @dt_data_f='"&mes_sel&"/"&dia_final&"/"&ano_sel&"', @dt_atualizacao = '"&mes_sel&"/"&dia_final&"/"&ano_sel&"', @ordem_funcionarios='"&ordem_funcionarios&"', @outras_variaveis='"&outras_variaveis_&"'"
								...
								'*** Mostra o cabeçalho ****
									...
									if cabecalho = "0" then%>
										...
										<tr bgcolor=#c0c0c0>
											...
											<td><b>demissão</b></td-->
											<%'end if%>
											<td><b>Admissão</b><br><img src="../../imagens/px.gif" alt="" width="60" height="1" border="0"></td>
											<!--td><b>Recisão</b><br><img src="../../imagens/px.gif" alt="" width="60" height="1" border="0"></td-->
								...
								IF mostrar_linha = 1 Then 'inibe a linha desejada%>
									...
									<tr onmouseover="mOvr(this,'#CFC8FF');" onmouseout="mOut(this,'<%=cor_linha%>');" style="height:20px; color:<%=cor_registro%>;" bgcolor="<%=cor_linha%>">
										<td align="center" valign="top" style="color:gray;">
											...
											<%'=%></td>
										<td align="right" valign="top"><a name="<%=cd_matricula%>"><%=cd_matricula%></a></td>
										<td valign="top" onclick="javascript:window.open('empresa/funcionario/funcionarios_ficha.asp?tipo=cadastro&pag=<%=strpag%>&cod=<%=cd_funcionario%>&busca=<%=strbusca%>','ficha<%=cd_funcionario%>','width=700,height=700,scrollbars=1');"><%=nm_funcionario%></td>
									...
									<%end if%>
										...
										<img src="../../imagens/ic_editar.gif" alt="Editar" width="13" height="14" border="0" onclick="javascript:window.open('empresa/funcionario/funcionarios_cadastro.asp?tipo=cadastro&pag=<%=strpag%>&cod=<%=cd_funcionario%>&busca=<%=strbusca%>','Cadastro_<%=cd_funcionario%>','width=770,height=700,scrollbars=1');"></td>
									</tr>
								<%if cor > 0 then
									cor_linha = "#d7d7d7"
									cor = 0
