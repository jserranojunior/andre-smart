...
<%qtd_dias_dsr = qtd_domingos_comp + qtd_feriados%>
			...
			<!-- ---------------------------------------------------------------- -->				
							...
							<tr bgcolor="#000000">
								<td colspan="100%" align="center" class="cabecalho" style="background-color:black; color:white;"><b>Relatório Mensal - BENEF&Iacute;CIOS (horas extras)<br><%=mes_selecionado(dt_mes)%>/<%=dt_ano%></b></td>
								<!--td colspan="2" rowspan="4" align="center"><img src="foto/funcionarios/Vdlap.gif" alt="" name="Vdlap.gif" id="Vdlap.gif" width="73" border="0"></td-->
							</tr>
							<tr>
								<td colspan="6">&nbsp;</td>
								...
								<td colspan="1">&nbsp;</td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
								<td align="center" colspan="2">Refeição</td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
								<td align="center" colspan="1"><b>TOTAL GERAL</b></td>
							</tr>
							<tr style="background-color:gray; color:white;">
								...
								<td align="center"><b>UND</b><br><img src="../../imagens/px.gif" alt="" width="30" height="1" border="0"></td>
							<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									<td align="center"><b>VT Extra</b><br><img src="../../imagens/px.gif" alt="" width="30" height="1" border="0"></td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>	
									<td align="center"><b>Valor</b><br><img src="../../imagens/px.gif" alt="" width="30" height="1" border="0"></td>
								...
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									...
									<td align="center"><b>Total</b><br><img src="../../imagens/px.gif" alt="" width="30" height="1" border="0"></td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									<td align="center"><b>Total Transp</b><br><img src="../../imagens/px.gif" alt="" width="30" height="1" border="0"></td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									<td align="center"><b>VR Extra</b><br><img src="../../imagens/px.gif" alt="" width="30" height="1" border="0"></td>
									<td align="center"><b>Total</b><br><img src="../../imagens/px.gif" alt="" width="30" height="1" border="0"></td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									<td align="center"><b>VT<br>VR</b><br><img src="../../imagens/px.gif" alt="" width="30" height="1" border="0"></td>
					...
					xsql = "up_funcionario_folhapagamento_geral @dt_comp_i='"&mes_competencia&"/1/"&ano_competencia&"', @dt_comp_f='"&mes_competencia&"/"&final_competencia&"/"&ano_competencia&"', @dt_i = '"&dt_mes&"/1/"&dt_ano&"', @dt_f = '"&dt_mes&"/"&dia_final&"/"&dt_ano&"', @outras_cond='"&outras_cond&"', @nm_ordem='"&nm_ordem&"'"
						Set rs = dbconn.execute(xsql)
							while not rs.EOF
								...
								'***** VT Cancelado **********************************************
								xsql = "SELECT * FROM TBL_Funcionario_valores WHERE cd_funcionario = "&strcod&" AND (cd_tipo = 4) AND (dt_atualizacao <= '"&dt_mes&"/1/"&dt_ano&"') AND (nr_valor > 0)"
							...
							'	nr_vr_extra = rs("nr_vr_extra")
									if  not IsNumeric(nr_vr_extra) Then 
										nr_vr_extra = "0"
									else
										dias_nr_vr_extra = nr_vr_extra
										'total_geral_vr_extra = total_geral_vr_extra + int(nr_vr_extra)
									end if
					...
					<%if int(strcd_unidade) = "0" OR int(cd_unidade) = int(strcd_unidade) then
							...
							<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
								<td align="center"><%if nr_vt_extra >= 1 then%><%=zero(nr_vt_extra)%><%else%>&nbsp;<%end if%>
							<%strsql = "SELECT * FROM VIEW_funcionario_beneficios where cd_funcionario='"&strcod&"' AND dt_atualizacao <= '"&dt_mes&"/1/"&dt_ano&"' AND cd_beneficio_tipo=2  order by dt_atualizacao desc"
								...
								total_geral_nr_vt_extra = abs(total_geral_nr_vt_extra) + abs(nr_vt_extra)
												...
												str_fornecedor = replace(str_fornecedor,":","")
													...
													if not rs_val.EOF then
														...
														valor_total = valor_diario * nr_vt_extra
															'valor_total_vt_mes = valor_total_mes + valor_total
															'valor_extra_total_mes = valor_extra_total_mes + valor_total_vt_mes
														
														
														if conta_col = 1 then
															total_sptrans = total_sptrans + valor_total
															total_geral_sptrans = total_geral_sptrans + total_sptrans
														elseif conta_col = 2 then
															total_cmt = total_cmt + valor_total
															total_geral_cmt = total_geral_cmt + total_cmt
														elseif conta_col = 3 then
															total_dia = total_dia + valor_total
															total_geral_dia = total_geral_dia + total_dia
														end if
														valor_total_vt_mes = total_sptrans + total_cmt + total_dia
														
														valor_total_geral_vt_mes = valor_total_geral_vt_mes + valor_total_vt_mes
													end if
													'valor_total_geral_vt_func = valor_total_geral_vt_func + total_sptrans + total_cmt + total_dia
													
											%>
										<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
											<td align="right"><%if nr_vt_extra <> 0 then response.write(formatnumber(valor_diario,2))%></td>
											<td align="right"><%if valor_total <> 0 Then response.write(formatnumber(valor_total,2))%> </td>
										<%
										next
										valor_total_geral_transp = valor_total_geral_transp + valor_total_vt_mes
								...
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									<td align="right"><%if valor_total_vt_mes <> 0 Then response.write("<b>"&formatnumber(valor_total_vt_mes,2)&"</b>")%></td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
								<%if nr_vr_extra <> 0 then total_vr_func = nr_vr_extra*12
									
									total_vr_mes = total_vr_mes + total_vr_func
									total_geral_vr_mes = total_geral_vr_mes + nr_vr_extra
									%>
									<td align="center"><%if nr_vr_extra <> 0 then response.write(zero(nr_vr_extra))%></td>	
									<td align="right"><%if total_vr_func <> 0 then response.write(formatnumber(total_vr_func,2))%></td>	
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									<%valor_total_func_mes = valor_total_vt_mes + total_vr_mes
									total_geral_vr = total_geral_vr + total_vr_mes
									if isnumeric(nr_vr_extra) then total_qtd_vr_mes = abs(total_qtd_vr_mes) + nr_vr_extra
									
									total_geral_func_mes = total_geral_func_mes + valor_total_func_mes
									'valor_total_func_mes = valor_total_vt_mes%>
									<td align="right"><%if valor_total_func_mes <> 0 then response.write(formatnumber(valor_total_func_mes,2))%></td>				
								<%'rs_ben.movenext
								'wend%>
							</tr>
						<%num_funcionario = num_funcionario + 1
							...
							<tr>
								...
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
								<td align="right">&nbsp;<b><%=total_geral_nr_vt_extra%></b></td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									<td align="right">&nbsp;</td>
									<td align="right">&nbsp;<b><%if total_geral_sptrans > 0 then%><%=formatnumber(total_geral_sptrans)%><%else%>0<%end if%></b></td>									
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>	
									<td align="right">&nbsp;</td>
									<td align="right">&nbsp;<b><%if total_geral_cmt > 0 then%><%=formatnumber(total_geral_cmt)%><%else%>0<%end if%></b></td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>	
									<td align="right">&nbsp;</td>
									<td align="right">&nbsp;<b><%if total_geral_dia > 0 then%><%=formatnumber(total_geral_dia)%><%else%>0<%end if%></b></td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									<td align="right">&nbsp;<b><%'=valor_extra_total_mes%><%=formatnumber(valor_total_geral_transp)%></b></td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									<td align="right">&nbsp;<b><%=total_qtd_vr_mes%></b></td>	
									<td align="right"><b><%=formatnumber(total_geral_vr,2)%></td>
								<td bgcolor="silver"><img src="../../imagens/px.gif" alt="" width="1" height="1" border="0"></td>
									<td align="right"><b><%=formatnumber(total_geral_func_mes,2)%></b></td>
							</tr>
