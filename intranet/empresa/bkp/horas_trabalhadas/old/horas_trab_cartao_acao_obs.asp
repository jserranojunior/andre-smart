...
<%		'If acao = "inserir" AND cd_folga <> "1" AND cd_dsr <> "1" Then
...
<!--#include file="../banco_horas/banco_horas_acao.asp"--><%
			...
			response.redirect "../../empresa_funcionarios_obs.asp?mes_sel="&mesentrada&"&ano_sel="&anoentrada&"&cd_codigo="&cd_codigo&"&tela="&tela&""
			
		'Elseif acao = "editar" AND cd_folga <> "1" AND cd_dsr <> "1" Then
...
<!--#include file="../banco_horas/banco_horas_acao.asp"--><%
		...
		'ElseIf acao = "excluir" AND cd_folga <> "1" AND cd_dsr <> "1" Then
