...
<body>
	<table border="1" align="center" style="border:0px solid black; border-collapse:collapse;">
			...
			<td colspan="4">
				<table border="1" style="border:1px solid gray; border-collapse:collapse;">
					...
					<tr>
						...
						<td><img src="../../imagens/px.gif" width="150" height="1"></td>
						<td><img src="../../imagens/px.gif" width="150" height="1"></td>
					</tr>
				</table>
			</td>
			...
			<td colspan="4">
				<table border="1" style="border:1px solid gray; border-collapse:collapse;">
					...
					<tr>
						...
						<td><img src="../../imagens/px.gif" width="245" height="1"></td>
						<td><img src="../../imagens/px.gif" width="60" height="1"></td>
						<td><img src="../../imagens/px.gif" width="70" height="1"></td>
		...
		<tr>
			<td colspan="4">
				<table border="1" style="border:1px solid gray; border-collapse:collapse;">
					...
					wend%>
					<tr>
						<td><img src="../../imagens/px.gif" width="203" height="1"></td>
		...
		<tr>
			...
			<td><b>Unidade:</b>
			<%strsql ="SELECT * From View_funcionario_unidade where cd_funcionario = "&str_funcionario&" and cd_suspenso <> 1 order by dt_atualizacao asc"
		...
		Set rs_hora = dbconn.execute(xsql)
		  ...
		  %>														
		<tr>
			<td><b>Entrada:</b> <%=zero(hour(hr_entrada))&":"&zero(minute(hr_entrada))%></td>
			<td><b>Intervalo:</b> <%=nm_intervalo%></td>
			<td><b>Saída:</b> <%=zero(hour(hr_saida))&":"&zero(minute(hr_saida))%></td>				
			<td>&nbsp;</td>
		</tr>
