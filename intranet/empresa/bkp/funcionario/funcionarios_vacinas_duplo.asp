					...
					'*** Mostra o cabeçalho ****
						...
						<%end if%>
							...
							<%if cabeca_exam = 0 AND isnull(val_vac) Then%>
								<tr><td align="center" colspan="8" style="color:white;" bgcolor="#808080"><span style="color:#ff0000;font-size:12px;"><<<</span> Vacinas não preenchidas <span style="color:#ff0000;">>>></span></td></tr>
							<%cabeca_exam = 1
							cabeca_exam1 = 0
							cor_val = "#000000"
							conta_vazios = 0
							...
							elseif cabeca_exam = 1 AND val_vac > -120 Then%>
								<tr><td align="center" colspan="8" style="color:white;" bgcolor="#808080"><span style="color:#ff0000;font-size:12px;"><<<</span> Vacinas já vencidos <span style="color:#ff0000;">>>></span></td></tr>
							<%cabeca_exam = 2
							cabeca_exam1 = 0
							cor_val = "#ff0000"
							conta_vencidos = 0
							...
							elseif cabeca_exam = 2 AND val_vac > 0 Then%>
								<tr><td align="center" colspan="8" style="color:white;" bgcolor="#808080"><span style="color:#fa9814;font-size:12px;"><<<</span> Vacinas vencendo <span style="color:#fa9814;">>>></span></td></tr>
							<%cabeca_exam = 3
							cabeca_exam1 = 0
							cor_val = "#c18509"
							conta_vencendo = 0
							...
							elseif cabeca_exam = 3 AND val_vac > 3 Then%>
								<tr><td align="center" colspan="8" style="color:white;" bgcolor="#808080"><span style="color:#00ff40;font-size:12px;"><<<</span> Vacinas OK <span style="color:#00ff40;">>>></span></td></tr>
							<%cabeca_exam = 4
							cabeca_exam1 = 0
							cor_val = "#000000"
							conta_ok = 0
