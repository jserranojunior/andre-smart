...
campos = request("campos")
	...
	campo_transporte = Instr(1,campos,"transporte",0)
	campo_alimentacao = Instr(1,campos,"alimentacao",0)
	campo_medica = Instr(1,campos,"medica",0)
...
nome = request("nome")
	if nome <> "" Then
		...
		'busca_nome = " nm_nome like '"&nome&"' AND "
		busca_nome = " cd_codigo=97 "
	end if 
sexo = request("sexo")
	if sexo > "0" Then
...
<table align="center" border="1" class="no_print">
	...
	<tr>
		<td>&nbsp;</td>
		<td><input type="checkbox" name="campos" value="conta_sal" <%if campo_conta_sal <> 0 Then response.write("CHECKED") end if%> style=border:0px;> Conta Salário</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td><input type="checkbox" name="campos" value="filia" <%if campo_filia <> 0 Then response.write("CHECKED") end if%> style=border:0px;> Filiação</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td><input type="checkbox" name="campos" value="alimentacao" <%if campo_alimentacao <> 0 Then response.write("CHECKED") end if%> style=border:0px;> Alimentação</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td><input type="checkbox" name="campos" value="medica" <%if campo_medica <> 0 Then response.write("CHECKED") end if%> style=border:0px;> Convênios</td>
		<td>&nbsp;</td>
