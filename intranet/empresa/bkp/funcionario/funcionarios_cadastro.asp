...
function adiciona_dependente(a,b,c,d,e,f,dependentes_total){
	...
	//chama Ajax	
	{
		...
		oHTTPRequest_dependentes.open("post", "dependentes/ajax/ajax_dependentes_lista.asp", true);
...
function adiciona_escolaridade(a,b,c,d,e,f,g,escolaridade_total){
	...
	//chama Ajax	
	{
		...
		oHTTPRequest_escolaridade.open("post", "escolaridade/ajax/ajax_escolaridade_lista.asp", true);
...
function adiciona_emprego(a,b,c,d,e,f,emprego_total){
	...
	//chama Ajax	
	{
		...
		oHTTPRequest_emprego.open("post", "emprego_anterior/ajax/ajax_emprego_lista.asp", true);
...
-->
					...
					<%else%>
					<table border="0" cellspacing="0" cellpadding="2" align="center" class="no_print" style="">
						...
						<%if strfoto = "" then%><%strfoto = "Vdlap.gif"%><%end if%>
							<tr>
								<td colspan="7" align="center" class="cabecalho" style="background-color:black; color:white;"><b>FICHA CADASTRAL DO COLABORADOR <%if strregime_trabalho <> "" Then%><%response.write("- "&strregime_trabalho&"."&strmatricula)%><%end if%></b></td>
							...
							<tr><td colspan="5"><img src="../../imagens/px.gif" width="712" height="1">&nbsp;</td></tr>
							<tr class="no_print">
								<td rowspan="7" align="center" valign="top" style="color:#7d7d7d;">									
							...
							<input type="hidden" name="contatos_total" value="" size="100">	
							...
							<tr>
								<td><b>Nome</b></td>
								<td><b>Parentesco<img src="../../imagens/px.gif" alt="" width="30" height="1" border="0">Sexo</b></td>
								<td><b>Data nasc.</b></td>
								<td><b>Observações.</b></td>
							</tr>
							...
							<tr>
								...
								<input type="hidden" name="dependentes_total" value="" size="100">	
							...
							<tr>
								...
								<td><b>Cancela Vale transporte</b></td>
								<td>&nbsp;</td>
							</tr>
							...
							<tr>
								...
								<td><!--input type="text" name="dt_contratado" value="<%'=Strdt_contratado%>" size="20" maxlength="10" class="inputs"-->
									<input type="text" name="cd_dia" value="" size="3" maxlength="2" class="inputs" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);">/
									<input type="text" name="cd_mes" value="" size="3" maxlength="2" class="inputs" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);">/
							...
							<tr>
								...
								<tr>
									<td>&nbsp;<a href="javascript:void();" onclick="window.open('../janelas/funcionarios_contrato_altera.asp?cod_contrato=<%=cod_contrato%>&cd_funcionario=<%=str_funcionario%>', 'janela_vdlap', 'width=335, height=205'); return false;"><%=nm_regime_trab%></a></td>
									<td>&nbsp;<%=zero(day(dt_admissao))%>/<%=mesdoano(month(dt_admissao))%>/<%=year(dt_admissao)%></td>
									<td>&nbsp;<%=dt_demissao%></td>
									<td>&nbsp;&nbsp;
									<%if dt_demissao <> "" then
										if nr_contrato = "" then%>
											<a href="javascript:;" onclick="window.open('../janelas/funcionarios_contrato.asp?cd_funcionario=<%=str_funcionario%>', 'janela_vdlap', 'width=350, height=400'); return false;"><b>*** Novo Contrato ***<!--img src="../../imagens/ic_aprovado.gif" alt="Novo Contrato." width="10" height="12" border="0" --></b></a>
										<%end if%>
									<%else%>
											<a href="javascript:;" onclick="window.open('../janelas/funcionarios_recisao.asp?cod_contrato=<%=cod_contrato%>&cd_funcionario=<%=cd_funcionario%>','principal','width=370, height=400'); return false;">Rescindir contrato?</a>&nbsp; <!--day(dt_demissao) = "" then%-->
									<%end if%></td>
								</tr>
							...
							<tr>
								...
								<td class="txt_cinza" colspan="2" <%=tipo%> style="background: #c7c7c7;"><a href="javascript:;" onclick="window.open('../janelas/funcionarios_cargo.asp?cd_funcionario=<%=strcod%>&cd_funcao=<%=cd_funcao%>', 'janela_vdlap', 'width=350, height=400, scrollbars=1'); return false;"><%=nm_cargo%>.</a>
								...
								<%strsql ="SELECT * From View_funcionario_status where cd_funcionario = "&strcod&"  and cd_suspenso <> 1 order by dt_atualizacao"
									...
									rs_status.movenext
									loop%>
									<a href="javascript:;" onclick="window.open('../janelas/funcionarios_status.asp?cd_funcionario=<%=strcod%>&cd_status=<%=cd_status%>', 'janela_vdlap', 'width=350, height=400,scrollbars=1'); return false;"><%=nm_status%>.</a>
								<%end if%>
									</td>
									<td style="background: #c7c7c7;">
								...
								<%else%>
									...
									rs_unidade.movenext
									loop%>
									 <a href="javascript:;" onclick="window.open('../janelas/funcionarios_unidade.asp?cd_funcionario=<%=strcod%>&cd_unidade=<%=cd_unidade%>', 'janela_vdlap', 'width=350, height=400,scrollbars=1'); return false;"><%=nm_unidade%>.</a>
									<%rs_uni.close
									Set rs_uni = nothing%>
								<%end if%></td>
							</tr>
