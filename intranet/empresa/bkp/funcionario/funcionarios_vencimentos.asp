...
function hepatb(){
		document.location= "http://desenv/empresa.asp?tipo=hepatb_vacina";	
	}
	
function dupla(){
		document.location= "http://desenv/empresa.asp?tipo=dupla_venc";	
	}
	
function scr(){
		document.location= "http://desenv/empresa.asp?tipo=scr_vacina";	
	}
	
function exame_med(){
		document.location= "http://desenv/empresa.asp?tipo=exammed_venc";	
	}
	
function coren(){
		document.location= "http://desenv/empresa.asp?tipo=coren_venc";	
	}
