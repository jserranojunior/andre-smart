...
cod_unidade = request("cod_unidade")
	...
	xsql = "sp_funcionarios_s02 @funcao='SU', @dt_listagem='"&ano&"-"&mes&"-"&dia&"', @nm_funcionario='"&nome&"', @cd_funcionario='"&cd_funcionario&"'"
	Set rs = dbconn.execute(xsql)
	
	if not rs.EOF Then
		nm_nome = rs("nm_nome")
		cd_codigo = rs("cd_codigo")
		nm_unidade_atual = rs("nm_unidade")		
	end  if
%>
...
<table border="0" align="center">
	...
	<%
  	strsql = "sp_funcionarios_s02 @funcao='SU', @dt_listagem='"&ano&"-"&mes&"-"&dia&"', @nm_funcionario='"&nome&"', @cd_funcionario='"&cd_funcionario&"'"
