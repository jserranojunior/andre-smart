	...
	<tr>
		...
		<td align="center">
			<%if cd_suspenso = 1 then%>
				<a href="../acoes/funcionarios_acao.asp?cod=<%=cd_status%>&cd_suspenso=0&tbl=status&acao=suspende&cd_funcionario=<%=cd_funcionario%>&func_ativos=<%=func_ativos%>"><img src="../../imagens/ic_pendente.gif" alt="<%=cd_codigo%>" width="10" height="12" border="0"></a>	
			<%else%>
				<a href="../acoes/funcionarios_acao.asp?cod=<%=cd_status%>&cd_suspenso=1&tbl=status&acao=suspende&cd_funcionario=<%=cd_funcionario%>&func_ativos=<%=func_ativos%>"><img src="../../imagens/check_ok.gif" alt="<%=cd_codigo%>" width="25" height="12" border="0"></a>
			<%end if%></td>
	</tr>
	<%
	nr = nr + 1
