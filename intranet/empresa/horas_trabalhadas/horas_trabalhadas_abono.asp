...
<form action="../../acoes/horas_trabalhadas_acao.asp" method="post" name="abonos" id="abonos">
<input type="hidden" name="cd_codigo" value="<%=cd_funcionario%>">
<input type="hidden" name="natureza" value="abono">
<!--início do abono<br>
