...
IF x = "" THEN
	...
	'ELSEIF acao = "excluir_pagamento_SUSPENSO" THEN
	ELSEIF acao = "excluir_pagamento" AND cd_user = 46 THEN
	'**************************************************
	...
	'*** Exclui a conta a pagar ***
		...
		dbconn.execute(xsql)
			...
			response.write("Excluído!<br>")
				if codigo_origem <> "" Then
					'xsql = "up_andamento_update_pagto2 @cd_os="&cd_os&",@cd_pagto=null"
					'xsql = "up_orcamento_update_pagto @cd_codigo="&codigo_origem&",@cd_pagamento=NULL"
