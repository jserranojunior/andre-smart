...
<table cellspacing="1" cellpadding="1" border="0" class="no_print">
	...
	<tr>
		<td align="center" colspan="2">CONTAS A PAGAR - ver2</td>
	</tr>
	<tr>
		<td><b>M&ecirc;s</b></td>
		<td><b>Ano</b></td>
	...
	<tr>
		<td align="center" colspan="2"><a href="financeiro.asp?tipo=diario2&dt_mes=<%=mes_anterior%>&dt_ano=<%=ano_anterior%>"><< Anterior </a>&nbsp; &nbsp; &nbsp; <a href="financeiro.asp?tipo=diario2&dt_mes=<%=month(now)%>&dt_ano=<%=year(now)%>">Atual</a> &nbsp; &nbsp; &nbsp; <a href="financeiro.asp?tipo=diario2&dt_mes=<%=mes_posterior%>&dt_ano=<%=ano_posterior%>">Próximo>></a></td>
	<tr>
		<td colspan="2">&nbsp;</td>
	</tr>
	<tr>
...
<table cellspacing="1" cellpadding="1" border="1" style="1">
	...
	'  strsql = "Select * from view_financeiro_diario2 where dt_contrato <= '"&dt_mes&"/1/"&dt_ano&"'" 
		xsql = "up_financeiro_diario2_lista @dt_i='"&dt_mes&"/1/"&dt_ano&"', @dt_f='"&dt_mes&"/"&dia_final&"/"&dt_ano&"'"
