...
function validar_especialidade(shipinfo){
	if (shipinfo.nm_especialidade.value.length==""){window.alert ("Digite uma especialidade.");shipinfo.nm_especialidade.focus();return (false);}	
	return (true);}
</script>
...
<form action="../acoes/cadastros_acao.asp" method="post" onsubmit="return validar_especialidade(document.Form);" name="Form">
...
<tr bgcolor="#f5f5f5">	
	...
	<td><input type="text" name="nm_especialidade" size="45" maxlength="50" class="inputs" value=""></td>
