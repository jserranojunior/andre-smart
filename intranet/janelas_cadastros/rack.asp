...
<form action="../acoes/cadastros_acao.asp" method="post" onsubmit="return validar_rack(document.Form);" name="Form">
...
<tr bgcolor="#f5f5f5">	
	...
	<td><input type="text" name="nm_rack" size="45" maxlength="50" class="inputs" value=""></td>
