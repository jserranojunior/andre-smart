...
<%if tipo_item = "e" then%>
	<tr>
		<td align="center"><b>Patrimônio/Numero Série:</b></td>
		<td><input type="text" name="num_patrimonio" maxlength="10" size="15" value="" class="inputs" onKeyup="mostra_patrimonio('e');">
				
	</tr>
	<tr><td colspan="4">
		<span id="divPat_mostra">
			<!-- Servem apenas para a validação do formulário -->
			<input type="hidden" name="cd_patrimonio" value="">
			<input type="hidden" name="cd_equipamento" value="">
			<input type="hidden" name="cd_marca" value="">
			<input type="hidden" name="cd_especialidade" value="">
			<input type="hidden" name="cd_ns" value="">
			<input type="hidden" name="num_qtd" value="">
		</span></td></tr>
<%elseif tipo_item = "o" then%>
	<tr>
		<td align="center"><b>Patrimônio:</b></td>
		<td><input type="text" name="num_patrimonio" maxlength="10" size="15" value="<%=cd_patrimonio%>" class="inputs" onFocus="nextfield ='num_qtd';"  onKeyup="mostra_patrimonio('o');">
	</tr>
	<tr><td colspan="4">
		<span id="divPat_mostra">
			<!-- Servem apenas para a validação do formulário -->
