...
<table align="center" border="0">
	<tr>
		<td>
			<table width="650" border="1" cellspacing="2" cellpadding="0" bordercolordark="#FFFFFF" bordercolorlight="#efefef">
				
					
				<tr id="no_print">		
						<td class="txt_cinza" colspan="12">
						<b>Manutenção &raquo; - <font color="red">Listagem <%=filtro%> - (Recuperação)</font></b></td>
						...
						<form action="manutencao2.asp" name="busca" id="busca">
							...
							<input type="text" name="cd_prefixo" size="2" maxlength="2"  onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);"><input type="text" name="cd_codigo" size="6" maxlength="6">
							<input type="hidden" name="campo" value="num_os">
							<input type="hidden" name="partic" value="busca">
					...
					<tr id="no_print"><td colspan="100%">NOVA O.S.:<input type="text" name="cd_unidade2" size="2" maxlength="2"  onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);"><input type="text" name="num_os2" size="10" maxlength="10"><input type="submit" value="ok"></td></tr>
					</form>
					<tr id="no_print"><td colspan="100%"><img src="imagens/blackdot.gif" alt="" width="100%" height="1" border="0"></td></tr>
					<tr id="no_print">
						<td colspan="9" class="textopequeno" bgcolor="#f5f5f5">
							<!--/ <a href="manut_os_nova.asp">Nova O.S. </a-->
						    / <a href="manutencao2.asp?tipo=pendencias">Pendentes</a> 
							...
							/ <a href="manutencao2.asp?tipo=relatorio">Relatório</a> /
						</td>
				</tr>
				<%if org = "os" then
					color_os = "green"
				...
				<tr id="no_print">
						<td colspan="100%" class="textopequeno" bgcolor="#f5f5f5">
							...
							<a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=os"><font color="<%=color_os%>">O.S.</font></a> /
							<a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=equip"><font color="<%=color_equip%>">Equip/Instr.</font></a> /
							<a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=marca"><font color="<%=color_marca%>">Marca</font></a> /
							<a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=unid"><font color="<%=color_unid%>">Unidade</font></a> / 
							<a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=fornec"><font color="<%=color_fornec%>">Ass. Técnica</font></a> / 
							<a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=prev"><font color="<%=color_prev%>">Prev. Retorno</font></a> /  
							<a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=aval"><font color="<%=color_aval%>">Avaliacao</font></a> / 
							<a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=sit"><font color="<%=color_sit%>">Situação</font></a> /
						</td>
				</tr>
				...
				<tr id="ok_print"><td colspan="100%"><img src="imagens/blackdot.gif" width="100%" height="2"></td></tr-->
					...
					<tr bgcolor="darkgray">
						...
						<td><b><a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=os"">O.S.</a></b></td>
						<!--td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><b><a href="manutencao.asp?tipo=pendencias&filtro=pendentes">PROVID.</a></b></td-->	
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><b><a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=envio">DATA ENVIO</a></b></td>
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=equip"><b>EQUIPAMENTO/<br>INSTRUMENTAL.</b></a></td>	
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><b>PAT</b></td>	
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<!--td><img src="px.gif" alt="" width="1" height="1" border="0"><b>PATRIM.</b></td>	
						<td><img src="imagens/px.gif" width="1" height="1"></td-->
						<td><a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=marca"><b>MARCA.</b></a></td>	
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=unid"><b>UNID.</b></a></td>		
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<!--td><img src="px.gif" alt="" width="1" height="1" border="0">&nbsp;&nbsp;&nbsp;</td/-->
						<td><a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=fornec"><b>ASSIST. TÉCNICA</b></a></td>
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=prev"><b>PREV. RETORNO</b></a></td>
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						...
						<%if strsession = 200 Then%>
						<td><img src="../imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao2.asp?tipo=pendencias&filtro=pendentes&org=sit"><b>diferença</b></a></td>
						<%end if%>
				</tr>
...
<%'3º
			...
			Do while not rs.EOF
				...
				cd_alerta = rs("cd_alerta")
					'*** Muda COR DA LINHA CASO A O.S. ESTEJA MARCADA COMO ALERTA ***
					if int(cd_alerta) = 1 then
						cor_alerta = "#66FF00"
						'cd_alerta = 0
					else'if 
						cor_alerta = "white"
				...
				<tr onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:;" onmouseout="mOut(this,'<%=cor_alerta%>');" bgcolor="<%=cor_alerta%>">
						<td valign="top" align="center" bgcolor="darkgray"><b><%=num%></b></td>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><a href="manutencao2.asp?tipo=andamento&cd_codigo=<%=cd_codigo%>&campo=cd_codigo"><font color="<%=cor_aviso%>"><%'=num_os%><%=zero(cd_unidade)%>.<%=manutencao(num_os)%></font></a></td>
						<!--td><img src="imagens/px.gif" width="1" height="1"></td>
						...
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><a href="manutencao2.asp?tipo=andamento&cd_codigo=<%=cd_codigo%>&campo=cd_codigo"><font color="<%=cor_aviso%>"><%'=dt_entrada%><%=dt_manut_orc%></font></a></td>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><font color="<%=cor_aviso%>"><%=Left(nm_equipamento,37)%></font></td>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<!--td valign="top"><font color="<%=cor_aviso%>"><%'=(cd_ns)%></font></td>
						<td><img src="imagens/px.gif" width="1" height="1"></td-->
						<td valign="top" align="right"><font color="<%=cor_aviso%>"><%=no_patrimonio%></font></td>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						...
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<!--td valign="top">&nbsp;</td/-->
						<td valign="top"><a href="javascript:;" onclick="window.open('manutencao2/fornecedor_cad.asp?cd_codigo=<%=cd_fornecedor%>&janela=pop_up', 'Fornecedor', 'width=517, height=290'); return false;"><font color="<%=cor_aviso%>"><%=Left(nm_fornecedor,12)%></font></a></td>		
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><a href="manutencao2.asp?tipo=andamento&cd_codigo=<%=cd_codigo%>&campo=cd_codigo"><font color="<%=cor_aviso%>"><%=dt_prev_retorno%></font></a></td>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><a href="manutencao2.asp?tipo=andamento&cd_codigo=<%=cd_codigo%>&campo=cd_codigo"><font color="<%=cor_aviso%>"><%=nm_avaliacao%></font></a></td>
						<td><img src="imagens/px.gif" width="1" height="1"></td><%if nm_situacao="Em estudo" Then%><%neg_1="<b>"%><%neg_2="</b>"%><%else%><%neg_1=""%><%neg_2=""%><%end if%>
						<td valign="top"><a href="manutencao2.asp?tipo=andamento&cd_codigo=<%=cd_codigo%>&campo=cd_codigo"><%=neg_1%><font color="<%=cor_aviso%>"><%=nm_situacao%></font><%=neg_2%></a></td>
						<%if strsession = "200" Then%>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
...
loop%>
				...
				<tr class="textopequeno" id="no_print"><td colspan="7">&nbsp;</td></tr>
					<tr id="no_print">
						...
						<%else%>
						<b><a href="manutencao2.asp?strtop=<%=strtop%>&filtro=<%=filtro%>&regf=<%=regf%>&regl=<%=regl%>&mov=avan&pagina=<%=pagina%>&num=<%=num%>">Próxima</a> </b>
						<%End if%>
