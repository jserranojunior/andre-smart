...
If rs.EOF Then%>
			...
			if jan = 1 then
				...
				<tr bgcolor="#<%=bg_cor%>">
					...
					<td align="center"><b><%if cd_natureza_os = 1 then%>Manutenção<%elseif cd_natureza_os = 2 then%>Compra<%end if%></b></td>
					<td colspan="2">&nbsp;</td>
				</tr>
				<tr bgcolor="#<%=bg_cor%>">
			...
			<!--Início da etapa 1.2-->				
				...
				<tr style="visibility:<%=visual%>;">
					<td colspan="5" align="right"><!--Separador de etapas-->&nbsp;
						<%if jan = 0 then%><a href="manutencao2.asp?tipo=nova2&cd_unidade2=<%=cd_unidade%>&cd_codigo=<%=cd_codigo%>&campo=cd_codigo&jan=<%=jan%>"> alterar &nbsp; </a>
						<%elseif jan = 1 then%><a href="manutencao_nova.asp?tipo=nova2&cd_unidade2=<%=cd_unidade%>&cd_codigo=<%=cd_codigo%>&campo=cd_codigo&jan=<%=jan%>"> alterar &nbsp; </a>
						<%end if%>
					</td>
				</tr>
		...
		<%end if%>
				...
				<tr bgcolor="#<%=bg_cor%>">
					<td  align="center">Ass. Téc / Fornecedor</td>
				...
				<tr><td colspan="5">&nbsp;</td></tr>
				<tr bgcolor="#b4b4b4">
					<td colspan="100%" align="center" class="textopadrao">ORÇAMENTO <b style="color:#b4b4b4;"><%=cd_cod_andamento%></b></td>
				</tr>
				<tr bgcolor="#<%=bg_cor%>">
					<td  align="center">Nº Orç.</td>
					<td colspan="1"><input type="text" name="num_os_assist" size="15" maxlength="100" class="inputs" value="<%=num_os_assist%>" onkeyup="mostra_orcamento();"></td>
					<td align="center">Data</td>
					<td colspan="2"><span id="divorcamento" style="font-size:11px;"><input type="text" name="dt_manut_orc" size="11" maxlength="50" class="inputs" value="<%=dt_manut_orc%>"></span></td>
					
				</tr>
				
				<tr bgcolor="#<%=bg_cor%>">
					<td  align="center">Data aprov.<br> orçamento</td>
				...
				<tr bgcolor="#<%=bg_cor%>">
					<td align="center">R$ (unitário)</td>
					<td colspan="2"><input type="text" name="cd_valor_unit" size="10" maxlength="10" value="<%=cd_valor_unit%>" onKeyup="valores();" style="text-align:right"> &nbsp; &nbsp; &nbsp; 
					Unidades <input type="text" name="cd_qtd_valor" size="5" maxlength="5" onKeydown="valores();" value="<%=cd_qtd_valor%>" onKeyup="valores();"> </td>
					<td  align="center"><b>Valor Total R$</b></td>
					<td><input type="text" name="cd_valor_orc" readonly="1" size="11" maxlength="20" class="inputs" value="<%=cd_valor_orc%>" onKeyup="valores();" style="text-align:right" ></td>
				</tr>
				<tr>
				<tr bgcolor="#<%=bg_cor%>">
