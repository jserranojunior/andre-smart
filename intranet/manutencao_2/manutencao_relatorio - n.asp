...
if questao = "quantidade" then
	...
	cond_pat = " AND (no_patrimonio = '"&nm_patrimonio&"')"
	...
	cond_nat_defeito = " AND (nm_natureza_defeito = '"&cd_motivo&"')"
	cond_motivo = " AND (motivo like '%"&busca_inteligente(motivo)&"%')"
...
'	End if
		...
		If cd_equipamento = "0" AND nm_equipamento_novo = "" Then
			cond_eqp_1 = ""
		ElseIf cd_equipamento = "0" AND nm_equipamento_novo <> "" Then
			cond_eqp_1 = "AND (nm_equipamento_novo Like '%"&busca_inteligente(nm_equipamento_novo)&"%')"
		End if
...
<%if campo_16 <> 0 Then%><td>&nbsp;Gestão</td><%end if%>
			...
			response.write("sp_manutencao_s01 @funcao='S', @dt_inicial='"&data_i&"', @dt_final='"&data_f&"',@cd_unidade='27'")
			xsql = "sp_manutencao_s01 @funcao='S', @dt_inicial='"&data_i&"', @dt_final='"&data_f&"',@cd_unidade='27'"
