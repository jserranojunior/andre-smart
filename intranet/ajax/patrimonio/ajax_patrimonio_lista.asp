...
response.write(subtotal_patrimonio)
		...
		if IsNumeric(pat_item) then
			...
			if cor_num = "1" then
				...
				<tr bgcolor="<%=cor_fundo%>">
					...
					<td bgcolor="#ffffff"><input type="button" name="subtrair" value="-" onFocus="soma_patrimonio('','<%=cd_patrimonio%>',document.getElementById('subtotal_patrimonio').value)" onKeyup="nextfield ='cd_patrimonio_busca';"><%=cd_patrimonio%></td>					
