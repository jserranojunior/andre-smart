		...
		if IsNumeric(mat_item) then
			...
			if cor_num = "1" then
				...
				<tr bgcolor="<%=cor_fundo%>">
					...
					<td bgcolor="#ffffff"><input type="button" name="subtrair" value="-" onFocus="soma_mat('','<%=cd_cod_material%>',document.form.qtd_material.value,document.form.materiais.value)" onKeyup="nextfield ='cd_material';"></td>					
				</tr>
