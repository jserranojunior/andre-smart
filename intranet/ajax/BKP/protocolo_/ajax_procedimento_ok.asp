...
<%Elseif not IsNumeric(cd_procedimento) then%>
		...
		<input type="Button" name="proced" value="ok" onFocus="nextfield ='cd_procedimento';" onclick="soma('',document.form.cd_procedimento_1.value,document.form.procedimentos.value);">
		<%rs_proc.close
		set rs_proc = nothing%>
