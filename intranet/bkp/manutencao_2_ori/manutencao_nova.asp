...
'*************************************
			...
			<!--Início da etapa 1.1-->
				...
				<tr bgcolor="#f5f5f5">
					...
					<!--td colspan="3"><input type="radio" name="cd_natureza_os" value="1">Manutenção &nbsp; &nbsp; &nbsp; <input type="radio" name="cd_natureza_os" value="2">Compra</td-->
				</tr>
				<tr bgcolor="#f5f5f5">
...
<SCRIPT LANGUAGE="javascript">
 {
  ...
  //MaskInput(document.form.cd_patrimonio, "99/99/9999");  
 }
</SCRIPT>
