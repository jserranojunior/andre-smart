...
<table align="center" border="0">
			...
			<table width="650" border="0" cellspacing="2" cellpadding="0" bordercolordark="#FFFFFF" bordercolorlight="#efefef">
					...
					<tr id="no_print">
						<td colspan="9" class="textopequeno" bgcolor="#f5f5f5">
						    ...
						    / <a href="manutencao.asp?tipo=pendencias">Pendentes</a> 
							  / <a href="manutencao.asp?tipo=especialidades">Especialidades</a> 
				...
				<tr id="no_print">
						<td colspan="100%" class="textopequeno" bgcolor="#f5f5f5">
							...
							<a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=os"><font color="<%=color_os%>">O.S.</font></a> /
							<a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=equip"><font color="<%=color_equip%>">Equip/Instr.</font></a> /
							<a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=marca"><font color="<%=color_marca%>">Marca</font></a> /
							<a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=unid"><font color="<%=color_unid%>">Unidade</font></a> / 
							<a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=fornec"><font color="<%=color_fornec%>">Ass. Técnica</font></a> / 
							<a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=prev"><font color="<%=color_prev%>">Prev. Retorno</font></a> /  
							<a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=aval"><font color="<%=color_aval%>">Avaliacao</font></a> / 
							<a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=sit"><font color="<%=color_sit%>">Situação</font></a> /
						</td>
				</tr>
				...
				<tr id="ok_print"><td colspan="100%"><img src="imagens/blackdot.gif" width="100%" height="2"></td></tr-->
					...
					<tr bgcolor="darkgray">
						...
						<td><b><a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=os"">O.S.</a></b></td>
						<!--td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><b><a href="manutencao.asp?tipo=pendencias&filtro=pendentes">PROVID.</a></b></td-->	
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><b><a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=envio">DATA ENVIO</a></b></td>
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=equip"><b>EQUIPAMENTO/<br>INSTRUMENTAL.</b></a></td>	
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><b>PAT</b></td>	
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<!--td><img src="px.gif" alt="" width="1" height="1" border="0"><b>PATRIM.</b></td>	
						<td><img src="imagens/px.gif" width="1" height="1"></td-->
						<td><a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=marca"><b>MARCA.</b></a></td>	
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=unid"><b>UNID.</b></a></td>		
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<!--td><img src="px.gif" alt="" width="1" height="1" border="0">&nbsp;&nbsp;&nbsp;</td/-->
						<td><a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=fornec"><b>ASSIST. TÉCNICA</b></a></td>
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=prev"><b>PREV. RETORNO</b></a></td>
						<td><img src="imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao.asp?tipo=pendencias&filtro=pendentes&org=aval"><b>AVALIAÇÃO</b></a></td>
						<td><img src="../imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=sit"><b>SITUAÇÃO</b></a></td>
						<%if strsession = 200 Then%>
						<td><img src="../imagens/px.gif" width="3" height="1"></td>
						<td><a href="manutencao.asp?tipo=<%=tipo%>&filtro=pendentes&org=sit"><b>diferença</b></a></td>
						<%end if%>
				</tr>
	...
	ordenacao = 1
		...
		'cond_icoes = " AND "'AND (CONVERT(VARCHAR(8), GETDATE(), 112) <= CONVERT(varchar(8), dt_prev_retorno, 112)) OR (fecha = 0) AND (dt_prev_retorno IS NULL)"
		cor_aviso = "black"
	...
	'end if
		...
		criterios = " Order by nm_especialidade ASC "
...
'		condicoes = " Where fecha IS NULL OR fecha = 0"
		...
		condicoes = " Where fecha IS NULL AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&" OR fecha = 0 AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&""
		strtop = "1000"
		criterios = " Order by nm_especialidade, nm_fornecedor ASC"
		'response.write("1.2")
		
		elseif filtro = "pendentes" AND org = "unid"  AND forn = "" Then
		condicoes = " Where fecha IS NULL AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&" OR fecha = 0 AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&""
		strtop = "1000"
		criterios = " Order by nm_especialidade, nm_unidade ASC"
		'response.write("1.3")
		...
		strtop = "1000"
		criterios = " Order by nm_especialidade, num_os ASC"
		'response.write("1.4")

		elseif filtro = "pendentes" AND org = "equip"  AND forn = "" Then
		condicoes = " Where fecha IS NULL AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&" OR fecha = 0 AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&" "
		strtop = "1000"
		criterios = " Order by nm_especialidade, nm_equipamento ASC"
		'response.write("1.5")
		
		elseif filtro = "pendentes" AND org = "marca"  AND forn = "" Then
		condicoes = " Where fecha IS NULL AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&" OR fecha = 0 AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&""
		strtop = "1000"
		criterios = " Order by nm_especialidade, nm_marca ASC"
		'response.write("1.6")
		
		elseif filtro = "pendentes" AND org = "aval"  AND forn = "" Then
		condicoes = " Where fecha IS NULL AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&" OR fecha = 0 AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&" "
		strtop = "1000"
		criterios = " Order by nm_especialidade, nm_avaliacao ASC"
		'response.write("1.7")
		
		elseif filtro = "pendentes" AND org = "sit"  AND forn = "" Then
		condicoes = " Where fecha IS NULL AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&" OR fecha = 0 AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&""
		strtop = "1000"
		criterios = " Order by nm_especialidade, nm_situacao ASC"
		'response.write("1.8")
		...
		condicoes = " Where fecha IS NULL AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&" OR fecha = 0 AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&" "
		strtop = "1000"
		criterios = " Order by nm_especialidade, dt_prev_retorno"
		'response.write("1.9")
		...
		condicoes = " Where fecha IS NULL AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&" OR fecha = 0 AND nm_solicitante <> '"&solicitante&"' "&cond_icoes&""
		strtop = "1000"
		criterios = " Order by nm_especialidade, dt_manut_orc"
		'response.write("2.0")
		...
		strtop = "1000"
		criterios = " Order by nm_especialidade, num_os desc"
		'response.write("10.0")
...
<%'3º
			...
			Do while not rs.EOF
				...
				if int(cd_especialidade) = "" then
					item = ""
				elseif int(cd_especialidade) <> int(especialidade) then
					item = "1"
				end if
				...
				if cd_especialidade <> especialidade AND especialidade <> ""then%>
				<tr><td colspan="100%"><!--Pula  linha --><br></br><br><b></b></td></tr>
				<%end if%>
				...
				<%if item = "1" Then%><tr><td colspan="7" align="left">_______________________________________________</td><td colspan="7" align="center"> <b><%=(nm_especialidade)%></b> </td><td colspan="7">___________________________________________________________</td></tr><%end if%>
				<tr onmouseover="mOvr(this,'#CFC8FF');"  onclick="javascript:;" onmouseout="mOut(this,'');">
						...
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<!--td valign="top">&nbsp;</td/-->
						<td valign="top"><a href="javascript:void(0);" onclick="window.open('../janelas_cadastros/fornecedor_cad.asp?cd_codigo=<%=cd_fornecedor%>&janela=pop_up', 'Fornecedor', 'width=517, height=290'); return false;"><font color="<%=cor_aviso%>"><%=Left(nm_fornecedor,12)%></font></a></td>		
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						...
						<%if strsession = "200" Then%>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
						<td valign="top"><font color="<%=cor_aviso%>"><%=item%> (<%=cd_especialidade%>/<%=especialidade%>)</font></td>
						<td><img src="imagens/px.gif" width="1" height="1"></td>
...
loop%>
				...
				<tr class="textopequeno" id="no_print"><td colspan="7">&nbsp;</td></tr>
					<tr id="no_print">
						...
						<%else%>
						<b><a href="manutencao.asp?tipo=<%=strtipo%>&strtop=<%=strtop%>&filtro=<%=filtro%>&regf=<%=regf%>&regl=<%=regl%>&mov=retr&pagina=<%'=pagina%>&num=1"">Início</a></b>
						<%End if%>
						&nbsp;&nbsp;&nbsp;
						<%If pagina = paginas Then%>
						<b><font color="#b7b7b7">Próxima</font></b>
						<%else%>
						<b><a href="manutencao.asp?tipo=<%=strtipo%>&strtop=<%=strtop%>&filtro=<%=filtro%>&regf=<%=regf%>&regl=<%=regl%>&mov=avan&pagina=<%=pagina%>&num=<%=num%>">Próxima</a> </b>
						<%End if%>
					...
					<tr><!-- id="no_print"--><td colspan="100%">
					<%'do while not num = "4500"%> <br>
					<%'num = num + 1
					'loop%>
						...
						</table--><%'response.write("SELECT "&selecao&" FROM "&tabela&"<br>"&condicoes&"<br>"&criterios&"'")%>
					</td></tr>
					<%'end if%>
				</table></td></tr></table>
