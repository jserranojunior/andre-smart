...
<table border="1" align="center" style="font-size:12px; font-family:arial; border-collapse:collapse;">
	...
	<tr>
		<td colspan="2" style="background-color:#eaeaea;">&nbsp;Histórico</td>
	...
	<tr style="background-color:green; font-size:12px; color:white;">
		...
		<%if cd_tipo_valor = 3 then '*** Valor parcelado *** 
			...
			<tr>
				...
				<td align="center"><%="<span style=color:gray;>"&formatnumber((total_pago/total_final)*100,2)&"%</span>"%> </td>
			</tr>
			<tr>
				...
				<td align="center"><%="<span style=color:gray;>"&formatnumber((saldo/total_final)*100,2)&"%</span>"%></td>
			</tr>
			<tr>
