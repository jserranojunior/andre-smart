...
' ****  AÇÕES  *******************************************************************************
	...
	Elseif acao = "inserir" AND modo = "unidade" then
		'Insere dados
		xsql = "up_unidade_insert @nm_unidade='"&nm_unidade&"', @nm_sigla='"&nm_sigla&"',@nm_endereco= '"&nm_endereco_completo&"', @dt_inicio_contrato="&dt_inicio_contrato&", @nm_cnpj='"&nm_cnpj&"', @nm_ie='"&nm_ie&"', @cd_hospital='"&cd_unidade_tipo&"', @cd_cliente_empresa='"&cd_empresa&"', @nm_cor='"&nm_cor&"', @data_atual='"&data_atual&"', @cd_user='"&cd_user&"'"
		dbconn.execute(xsql)
		'Após incluir unidade, fecha a janela
		
	Elseif acao = "editar" AND modo = "unidade" then
		xsql = "up_unidade_update @cd_unidade='"&cd_unidade&"', @nm_unidade='"&nm_unidade&"', @nm_sigla='"&nm_sigla&"',@nm_endereco= '"&nm_endereco_completo&"', @dt_inicio_contrato="&dt_inicio_contrato&", @dt_fim_contrato="&dt_fim_contrato&", @nm_cnpj='"&nm_cnpj&"', @nm_ie='"&nm_ie&"', @cd_hospital='"&cd_unidade_tipo&"', @cd_cliente_empresa='"&cd_empresa&"', @nm_cor='"&nm_cor&"', @cd_status='"&cd_status&"', @data_atual='"&data_atual&"', @cd_user='"&cd_user&"'"
		dbconn.execute(xsql)
