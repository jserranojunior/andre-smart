...
<tr bgcolor="<%=atividade%>">
	<td align="center" colspan="100%" style="color:red;font-size=13px;"><b>Listagem de nomes de<br>equipamentos/óticas/instrumentos/materiais</b></td>
</tr>


<tr>
	<td >&nbsp;<%if status <> 0 or status = "" then%><b>BUSCA: <input type="text" name="busca_equipamento" class="inputs" size="10" maxlength="30" value="<%=cd_equipamento%>" onKeyup="mostra_equipamento();"><%end if%></td>
	<td align="center"><a href="javascript:void(0);" onClick="window.open('ferramentas/equipamento_cad.asp','itens_nomes','width=500,height=160')" return false;">Novo</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
