...
<%if strcd_unidade <> "" Then
	...
	<tr bgcolor="<%=atividade%>">
	    <td>&nbsp; CNPJ:</td>
	    <td><input type="text" name="nm_cnpj" size="20" value="<%=cd_cnpj%>" class="inputs"></td>
		<td>&nbsp; I.E.:</td>
		<td><input type="text" name="nm_ie" size="20" value="<%=cd_ie%>" class="inputs"></td>
	</tr>
	<tr bgcolor="<%=atividade%>">
	    <td>&nbsp; Tipo:</td>
	    <td>
