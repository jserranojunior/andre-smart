...
******************************************************-->	
	...
	<%end if%>		
		...
		<tr><td style="border:1px; solid red;" colspan="100%" align="center" >
			<%'=qtd_vez%><%'=linha_pagina&"/"& mostra_rod+3%> Procedimentos Médicos Realizados com <%=a056_desrac%><br>		
		</td></tr>
		<tr><td colspan="100%"><img src="../imagens/blackdot.gif" alt="" width="100%" height="1" border="0"></td></tr>
...
'*****************************************************************************************************************************
'*************************************** RODAPÉ DO RELATÓRIO DE PROCEDIMENTOS ************************************************
'*****************************************************************************************************************************
...
'****************************************************************************************************
'*************************** FIM DA 1ª PARTE do RELATÓRIO DE PROCEDIMENTOS **************************
'****************************************************************************************************%>	
<!--****************************************************
***													 ***
***  INICIO DO RELATÓRIO DE EMPRESTIMO DE MATERIAIS  ***
***													 *** 
*****************************************************-->
	...
	if numero = 1 then
		...
		<%mostra_cab = mostra_cab + 1
			...
			<%if mostra_rod = qtd_linhas_pag then 'OR i = pre_conta - 1 then
				...
				if ultimo_antes_pulo < qtd_linhas_pag then '*** Repete as linhas em branco para posicionar o rodapé (página antes do fim)
			...
			<tr style="font-size:10px;" id="print_ok">
				<td colspan="3">&nbsp;</td>
				<td colspan="3" align="center">Data de emissão: <b><%=zero(day(now))&"/"&mesdoano(month(now))&"/"&right(year(now),2)&" "&hour(now)&":"&minute(now)%></b></td>
				<td colspan="2"align="right">Pág.:<%=pagina%>&nbsp;&nbsp;&nbsp;<%'=mostra_empr%></td></tr>
			<tr id="no_print"><td>&nbsp;</td></tr>			
			<tr style="page-break-after:always;"><td align="right" colspan="100%">&nbsp;<!-- Pula página <%'=ultimo_antes_pulo%>--></td></tr>								
			<%pagina = pagina + 1
		...
		next%>
			<tr><td colspan="100%"><img src="../imagens/blackdot.gif" alt="" width="100%" height="1" border="0"></td></tr>
			<tr>
				<td colspan="4" style="font-size:10px;"><%'=mostra_rod%>&nbsp;Total de procedimentos de empréstimos: <%=qtd_empr-1%></td>
