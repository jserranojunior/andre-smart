		...
		<tr>
			...
			<td colspan="3">&nbsp;<b><input type="text" name="cd_especialidade" size="3" class="inputs" value="<%=cd_especialidade%>" onKeyup="mostra_espec();" onFocus="nextfield ='cd_procedimento';">
		...
		<tr>
			...
			&nbsp; &nbsp; &nbsp;Material &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; Qtd.<br>
			<b><input type="text" name="cd_material" size="10" maxlength="30" class="inputs"  onKeyup="mostra_material();" onFocus="nextfield ='qtd_material';">
			...
			<!--input type="button" name="somar_mat" value="+" onFocus="soma_mat(document.form.cd_material_1.value,document.form.cd_material_2.value,document.form.qtd_material.value,document.form.materiais.value)" onKeyup="nextfield ='cd_material';"-->&nbsp;
