...
<%elseif cd_unidade <> "" AND mensagem = "" then '%>	
	...
	<tr>
		<td>Tipo de impressão</td><%if tipo_print = 1 Then%><%t_print_ck1 = "checked"%><%end if%>
		<td><input type="radio" name="tipo_print" value="1" <%=t_print_ck1%>>Somente Nº<br>
			...
			<input type="radio" name="tipo_print" value="3" <%=t_print_ck3%>>Formulário e Nº (Completo)</td>
	</tr>
	<%else '%>
...
<%end if%>
	<tr>
		<td colspan="2" align="center"><input type="submit" name="Imprimir" value="Preparar impressão" width="20">&nbsp;&nbsp;&nbsp;&nbsp;<a href="protocolo.asp?tipo=etiquetas"><img src="../../imagens/ic_reprovado.gif" alt="" width="10" height="12" border="0"></a><br>
	</tr>	
	</form>
</table>
<br id="no_print">
...
<table align="center" id="no_print" style="position:relative; top:20px; left:-300px;">
	...
	<tr>
		<td align="center">&nbsp;<br><a href="protocolo/acoes/etiquetas_acao.asp?cd_unidade=<%=cd_unidade%>&cd_num_inicio=<%=int(num_print_now)%>&qtd_paginas=<%=qtd_paginas%>&tipo_print=<%=tipo_print%>&session_cd_usuario" onClick="window.print()"><b>Sim</b></a> &nbsp; &nbsp; &nbsp; <a href="protocolo.asp?tipo=etiquetas"><b>Não</b></a><p style="color:red;"><b>ATENÇÃO</b>: Após confirmar, clique em <br>preferências e certifique-se que o tamanho<br>da página está definido como <b>A4</b></p><input type="button" onclick="visualizarImpressao();" value="Visualizar Impressão" /></td>
	</tr>
</table>
<%end if
