	...
	<tr>
		...
		<tr><td align="center"-->
			<table border="1" bordercolor="#C0C0C0" cellpadding="0" cellspacing="0" bordercolordark="#FFFFFF" id="no_print" >
				...
				<tr id="no_print">
					<td colspan="1"><img src="imagens/px.gif" width="20" height="1"></td>
					<td colspan="3"><img src="imagens/px.gif" width="125" height="5"></td>
					<td colspan="4"><img src="imagens/px.gif" width="520" height="1"></td>
...
<!-- *** Data *** -->
				<tr id="no_print" onmouseover="mOvr(this,'#e6e6e6');"  onclick="javascript:;" onmouseout="mOut(this,'');">
					<td colspan="3">
						<%if data <> 0  then%>
					<%ck_data = "checked"%>
					<%end if%>						
...
<!-- *** Procedimento *** -->
				<tr id="no_print">
					...
					<td colspan="4"><!--input type="text" name="procedimento" size="50" maxlength="50" class="inputs"-->&nbsp;</td>
...
<!-- ***********************************************************************************************-->
				...
				<tr id="no_print">
					...
					<select name="sentido" size="1">
						...
						<%end if%>
						<option value=""></option>
						<option value="ASC" <%=cres%>>Crescente</option>
						<option value="DESC" <%=decr%>>Decrescente</option>
					</select>
					</td>
				</tr>		
				<tr id="no_print">
...
'ok = ""
	...
	if ok <> "" Then 'Inicio do resultado da pesquisa
			...
			'******************************	%>
				...
				<tr bgcolor="#c0c0c0">
					<td>Nº<br><img src="../imagens/blackdot.gif" alt="" width="20" height="1" border="0"></td>
					<td>Qtd<br><img src="../imagens/blackdot.gif" alt="" width="22" height="1" border="0"></td>
					<%if campo_1_1 > 0 OR cd_unidade > 0 OR nm_unidade <> "" then%><td>Unid.<br><img src="../imagens/blackdot.gif" alt="" width="40" height="1" border="0"></td><%end if%>
					<%if campo_2_1 > 0 then%><td>Protocolo<br><img src="../imagens/blackdot.gif" alt="" width="80" height="1" border="0"></td><%end if%>
					<%if campo_3_1 > 0 OR nm_paciente <> "" then%><td colspan="2" align>Paciente<br><img src="../imagens/blackdot.gif" alt="" width="270" height="1" border="0"></td><%end if%>
					...
					<%if campo_6_1 > 0 then%><td>Convênio<br><img src="../imagens/blackdot.gif" alt="" width="180" height="1" border="0"></td><%end if%>
					<%if campo_7_1 > 0 then%><td colspan="2">Equipe Médica<br><img src="../imagens/blackdot.gif" alt="" width="270" height="1" border="0"></td><%end if%>
					...
					<%if campo_11_1 > 0 then%><td>Rack<br><img src="../imagens/blackdot.gif" alt="" width="160" height="1" border="0"></td><%end if%>
					<%if campo_12_1 > 0 then%><td>Especialidade<br><img src="../imagens/blackdot.gif" alt="" width="80" height="1" border="0"></td><%end if%>
					<%if campo_13_1 > 0 then%><td>tipo<br><img src="../imagens/blackdot.gif" alt="" width="80" height="1" border="0"></td><%end if%>
					<%if campo_14_1 > 0 then%><td>Procedimento<br><img src="../imagens/blackdot.gif" alt="" width="430" height="1" border="0"></td><%end if%>
...
'				'cd_codigo = rs("cd_codigo")
			...
			<%end if%>	
				...
				<%if campo_14_1 > 0 then%>	
					<td valign="top" width="800">						
						<%if campo_2_1 > 0 then
							...
							'strsql_proc = "SELECT * FROM View_protocolo_procedimento WHERE a002_numpro = "&a002_numpro&" AND a003_propri = 'S' ORDER BY a003_propri desc"
							Set rs_proc = dbconn.execute(strsql_proc)%>
								<%while not rs_proc.EOF
								'cd_proc = rs_proc("a002_numseq")
								'a058_numpro = rs_proc("a058_numpro")							
				...
				<%if campo_15_1 > 0 then
					...
					<td valign="top" width="800">
						<%'strsql_mat = "SELECT * FROM view_protocolo_material WHERE a002_numseq = '"&cd_protocolo&"' and a053_cod_ung = "&cd_unidade&""
						strsql_mat = "SELECT * FROM view_protocolo_material WHERE a002_numseq = '"&a002_numpro&"' and a053_codung = "&cd_unidade&""
