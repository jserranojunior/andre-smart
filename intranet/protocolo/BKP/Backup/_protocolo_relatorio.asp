	...
	<%if ok <> "" Then 'Inicio do resultado da pesquisa
			...
			'******************************	%>
				...
				<tr bgcolor="#c0c0c0">
					...
					<%if campo_1_1 > 0 OR cd_unidade > 0 OR nm_unidade <> "" then%><td>Unid.<br><img src="../imagens/blackdot.gif" alt="" width="30" height="1" border="0"></td><%end if%>
					...
					<%if campo_11_1 > 0 then%><td>Rack<br><img src="../imagens/blackdot.gif" alt="" width="80" height="1" border="0"></td><%end if%>
