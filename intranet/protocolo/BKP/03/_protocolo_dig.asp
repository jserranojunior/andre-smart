		...
		<tr>
			...
			<td colspan="2">&nbsp;<b><input type="text" name="cd_especialidade" size="3" class="inputs" value="<%=cd_especialidade%>" onKeyup="mostra_espec();" onFocus="nextfield ='cd_co';">
			<span id='divEspec'><select name="cd_especialidade_1" class="inputs" onFocus="nextfield ='cd_co';">
								<option value=""></option>
			...
			<td><input type="checkbox" name="cd_co" value="1" <%=co_ck%> onFocus="nextfield ='cd_procedimento_busca';">&nbsp;Sim</td>
		</tr>
...
<SCRIPT LANGUAGE="javascript">
	function JsProcDelete(cod1,cod2,cod3,cod4)
	{
	  if (confirm ("Tem certeza que deseja excluir o procedimento?"))
		  {
			document.location.href('protocolo/acoes/protocolo_acao.asp?cd_codigo='+cod1+'&cd_protocolo='+cod2+'&cd_unidade='+cod3+'&cd_digito='+cod4+'&obj_excl=6&acao=excluir');
		  }
	}
