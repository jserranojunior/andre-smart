		...
		<tr bgcolor="#f5f5f5">
			<td colspan="100%">&nbsp;Protocolo: <b><%=digitov(zero(int(cd_unidade))&"."&proto(no_protocolo))%> &nbsp;<%=mensagem%></b></td>
		</tr>
		<tr bgcolor="#808080">
			<td align="center" colspan="100%"><font color="white"><b>&nbsp;Identificação do Paciente - Etiqueta</b></font></td>
		</tr>
		<tr bgcolor="#e0e0e0">
		...
		<tr bgcolor="#f7f7f7">
			...
			<td align="left"><b><!--select name="nm_sexo" size="1" class="inputs" onFocus="nextfield ='nm_agenda_cirurgia';"-->
							<select name="nm_sexo" size="1" class="inputs" onFocus="nextfield ='nm_cirug_realizada';">
							 <option value=""></option>
		...
		<tr bgcolor="#f7f7f7"><td colspan="100%">&nbsp;<!--Pula linha 1--></td></tr>
		<tr bgcolor="#808080">
			<td align="center" colspan="100%"><font color="white"><b>&nbsp;Agenda</b></font></td>
		</tr>
		<tr bgcolor="#e0e0e0">			
		...
		%>					
			...
			<td><b><input type="text" size="2" name="dt_hora_agenda" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);" maxlength="2" class="inputs" value="<%=zero(dt_hr_agenda)%>" onFocus="nextfield ='dt_hora_inicio';"> :
				<!--input type="text" size="2" name="dt_minuto_agenda" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);" maxlength="2" class="inputs" value="<%=zero(dt_min_agenda)%>" onFocus="nextfield ='dt_hora_inicio';"-->
				<input type="text" size="2" name="dt_minuto_agenda" maxlength="2" class="inputs" value="<%=zero(dt_min_agenda)%>" onFocus="nextfield ='dt_hora_inicio';"></b></td>
			<td>&nbsp;</td>
		</tr>
		<tr bgcolor="#f7f7f7"><td colspan="100%">&nbsp;<!--Pula linha--></td></tr>
		<tr bgcolor="#e0e0e0">
			<td>&nbsp;Cirurgia Realizada?</td>
			<td colspan="1">&nbsp;Início</td>
			<td>&nbsp;Término</td>
			<td>&nbsp;Realizada no <b>C</b>entro <b>O</b>bstetrico?</td>
		</tr>
		
		<tr bgcolor="#f7f7f7">
			<td><b>
				<select name="nm_cirug_realizada" class="inputs" onFocus="nextfield ='dt_dia_cirurgia';">
					<option value=""></option>
			...
			<td colspan="1">&nbsp;<b><input type="text" size="2" name="dt_hora_inicio" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);" maxlength="2" class="inputs" value="<%=zero(dt_hr_inicio)%>" onFocus="nextfield ='dt_hora_fim';"> :
			...
			<td>&nbsp;<b><input type="text" size="2" name="dt_hora_fim" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);" maxlength="2" class="inputs" value="<%=zero(dt_hr_fim)%>" onFocus="nextfield ='cd_co';"> :
				<input type="text" size="2" name="dt_minuto_fim" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);" maxlength="2" class="inputs" value="<%=zero(dt_min_fim)%>" onFocus="nextfield ='cd_co';"></b></td>
			<td>&nbsp;<input type="checkbox" name="cd_co" value="1" <%=co_ck%> onFocus="nextfield ='cd_crm';">&nbsp;Sim</td>	
		</tr>
		<tr bgcolor="#f7f7f7"><td colspan="100%">&nbsp;<!--Pula linha--></td></tr>
		<tr bgcolor="#808080">
			<td align="center" colspan="100%" style="color:white;"><b>&nbsp;Procedimento Cirúrgico</b></td>
		</tr>
		<tr bgcolor="#e0e0e0">
		...
		<tr bgcolor="#f7f7f7">
			<%strsql ="Select * from TBL_Medicos Where A055_codmed='"&cd_med&"' and a055_status = 1"
					...
					set rs_med = nothing
					'wend' if%>
			<td colspan="4">&nbsp;<b><input type="text" name="cd_crm" class="inputs" size="10" maxlength="30" value="<%=cd_crm%>" onKeyup="mostra_medico();" onFocus="nextfield ='cd_rack';" >
		...
		<tr bgcolor="#f7f7f7">
			<td colspan="2">&nbsp;<b><input type="text" name="cd_rack" size="3" class="inputs" value="<%=cd_rack%>" onKeyup="mostra_rack();" onFocus="nextfield ='cd_especialidade';">
			...
			<td colspan="2">&nbsp;<b><input type="text" name="cd_especialidade" size="3" class="inputs" value="<%=cd_especialidade%>" onKeyup="mostra_espec();" onFocus="nextfield ='cd_procedimento_busca';">
...
<%if oticas = xx Then%>
		...
		***** NOVA ÁREA DE INCLUSÃO DE ÓTICAS*****-->		
		...
		<tr>
			<td colspan="100%" bgcolor="#f7f7f7">
			<b><input type="text" name="cd_patrimonio_busca" size="10" maxlength="30" class="inputs" onFocus="nextfield ='somar_pat';" onKeyup="mostra_patrimonio();">
			&nbsp; <span id='divPat_mostra'>&nbsp;
				<!--input type="Button" name="somar_pat" value="ok" onFocus="soma_patrimonio(document.Form.cd_patrimonio_busca.value,'',document.Form.subtotal_patrimonio.value)"-->
				<input type="Button" name="somar_pat" value="ok">
			</span>
			<br>			
			<input type="hidden" name="subtotal_patrimonio" value=""><br>			
		...
		<tr bgcolor="#f7f7f7">
			<td colspan="100%" bgcolor="#f5f5f5"><%'***** Substitui a vírgula pela sentença de busca *****
		if cd_cod_protocolo <> "" Then
			strsql ="Select * from VIEW_protocolo_patrimonio_lista where cd_protocolo="&cd_cod_protocolo&" order by cd_patrimonio"
			Set rs_pat = dbconn.execute(strsql)
			if not rs_pat.EOF Then cd_patrimonio = rs_pat("cd_patrimonio") end if%>
			<table border="0">
				<tr>
					<td bgcolor="#f5f5f5"><img src="../imagens/px.gif" alt="" width="50" height="1" border="0"></td>
					<td align="right" valign="top" style="width:100px; color:white;" bgcolor="#d1d1d1">Código</td>
					<td style="width:450px" style="width:100px; color:white;" bgcolor="#d1d1d1">&nbsp;Patrimonio</td>
					<td bgcolor="#d1d1d1"><img src="../imagens/px.gif" alt="" width="50" height="1" border="0"></td>
				</tr>
			<%num_cor = 1
			Do while not rs_pat.EOF%>
				...
				<%if num_cor = 1 then cor_linha = "#e5e5e5" else cor_linha = "#ffffff" end if%>
					<tr>
						...
						<td align="right" valign="top" style="width:100px" bgcolor="<%=cor_linha%>"><%=rs_pat("nm_tipo")%><%=rs_pat("cd_patrimonio")%>&nbsp;</td>
...
<SCRIPT LANGUAGE="javascript">
	function JsProcDelete(cod1,cod2,cod3,cod4)
	{
	  if (confirm ("Tem certeza que deseja excluir o procedimento?"))
		  {
			document.location.href('protocolo/acoes/protocolo_acao.asp?cd_codigo='+cod1+'&no_protocolo='+cod2+'&cd_unidade='+cod3+'&no_digito='+cod4+'&acao=excluir&obj_excl=6');
		  }
	}
	...
	function JsMatDelete(cod1,cod2,cod3,cod4)
	{
	  if (confirm ("Tem certeza que deseja excluir o material de empréstimo?"))
		  {
			document.location.href('protocolo/acoes/protocolo_acao.asp?cd_material='+cod1+'&no_protocolo='+cod2+'&cd_unidade='+cod3+'&no_digito='+cod4+'&obj_excl=3&acao=excluir');
		  }
	}
	...
	function JsPatDelete(cod1,cod2,cod3,cod4)
	{
	  if (confirm ("Tem certeza que deseja excluir esta ótica?"))
		  {
			document.location.href('protocolo/acoes/protocolo_acao.asp?cd_codigo='+cod1+'&no_protocolo='+cod2+'&cd_unidade='+cod3+'&no_digito='+cod4+'&obj_excl=7&acao=excluir');
		  }
	}
