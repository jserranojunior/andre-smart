		...
		<tr>
			<%strsql ="Select * from TBL_Medicos Where A055_codmed='"&cd_med&"'"
					...
					loop
					'wend' if%>
			<td colspan="100%">&nbsp;<b><input type="text" name="cd_crm" class="inputs" size="10" maxlength="10" value="" onKeyup="mostra_medico();"><!--onFocus="nextfield ='cd_rack';" -->
		...
		<span id='divMed'><select name="cd_crm_1" class="inputs" onFocus="nextfield ='cd_rack';" onFocus="nextfield ='cd_rack';">
			...
			<a href="javascript: void(0);" onclick="window.open('janelas_cadastros/medicos_cad.asp?janela=pop_up&metodo=fecha', 'principal', 'width=490, height=160'); return false;"><img src="../imagens/ic_novo.gif" alt="inserir" border="0"></a></td>							
		</tr>
		<tr><td colspan="100%">&nbsp;<!--Pula linha--></td></tr>
		<tr bgcolor="#e0e0e0">
			<td>&nbsp;Rack</td>
		...
		<tr>
			...
			&nbsp; <select name="cd_procedimento_1" class="inputs"  onclick="soma(document.form.cd_procedimento.value,document.form.cd_procedimento_1.value,document.form.procedimentos.value)" onFocus="nextfield ='done';">
				...
				<option value="<%=rs_proc("cd_codigo")%>" <%'=ck_proc%>><%=left(rs_proc("nm_procedimento"),25)%></option><%rs_proc.movenext
		 		Loop%>
			</select>
