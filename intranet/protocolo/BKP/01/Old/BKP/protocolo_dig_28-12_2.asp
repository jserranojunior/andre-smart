		...
		<tr>
			<%strsql ="Select * from TBL_Medicos Where A055_codmed='"&cd_med&"'"
					...
					loop
					'wend' if%>
			<td colspan="100%">&nbsp;<b><input type="text" name="cd_crm" class="inputs" size="10" maxlength="30" value="" onKeyup="mostra_medico();" onFocus="nextfield ='cd_rack';" >
		...
		<tr>
			<td colspan="100%">
			<b><input type="text" name="cd_material" size="10" maxlength="30" class="inputs"  onKeyup="mostra_material();" onFocus="nextfield ='somar_mat';">
			<input type="button" name="somar_mat" value="+" onFocus="soma_mat(document.form.cd_material.value,document.form.cd_material_1.value,document.form.cd_material_2.value,document.form.materiais.value)" onKeyup="nextfield ='cd_material';">&nbsp;
			&nbsp; <span id='divMat'>&nbsp;</span><!-- resultado do campo cd_material -->
			<input type="hidden" name="cd_material_2" value="">
			<br><input type="hidden" name="materiais" value="<%=cd_materiais%>">
			<input type="hidden" name="res_mat" size="5">
			
			<span id='divMatc'><!-- resultado da soma-->
		...
		<tr>
			<td colspan="100%" bgcolor="#f5f5f5"><%'***** Substitui a vírgula pela sentença de busca *****
		if not cd_material = "" Then
			strsql ="Select * from TBL_protocolo_material where A002_numseq="&cd_material&""
			...
			cd_material = rs_mat("a061_codmat")
				...
				<%Do while not rs_material.EOF%>
					<tr>
						<td bgcolor="#f5f5f5"><img src="../imagens/px.gif" alt="" width="50" height="1" border="0"></td>
						<td align="right" valign="top"><%=rs_material("cd_material")%>&nbsp;-</td>
						<td><%=left(rs_material("a061_nommat"),80)&"<br>"%></td>
						<td bgcolor="#f5f5f5"><img src="../imagens/px.gif" alt="" width="50" height="1" border="0"></td>
					</tr>				
		...
		<!--tr><td>Materiais</td></tr>
		<tr>
			<td colspan="100%">
			<input type="text" name="cd_material" size="10" maxlength="30" class="inputs" onKeyup="mostra_material();" onFocus="nextfield ='somar_materiais';">
			<input type="button" name="somar_materiais" value="+" onFocus="soma_mat(document.form.cd_material.value,document.form.cd_material_1.value,'',document.form.materiais.value)" onKeyup="nextfield ='cd_material';">
			<span id='divMat'>
			</span>
			<br>
			subtrai: <input type="text" name="cd_material_2" value=""><input type="button" name="somar_materiais" value="-" onFocus="soma_mat(document.form.cd_material.value,document.form.cd_material_1.value,document.form.cd_material_2.value,document.form.materiais.value)" onKeyup="nextfield ='cd_material';"><br>
			Total: <input type="text" name="materiais" value=""><br>
			<input type="hidden" name="res_mat">
			</td>
			
		</tr>
		<tr><td><span id='divCMat'>lista de materiais em branco (inicial)
			</span></td></tr>
		<tr>
			<td><img src="../imagens/blackdot.gif" alt="" width="100%" height="1" border="0"></td>
			<td colspan="2"><img src="../imagens/blackdot.gif" alt="" width="290" height="1" border="0"></td>
			<td><img src="../imagens/blackdot.gif" alt="" width="100%" height="1" border="0"></td>							
		</tr-->
		<tr><td colspan="100%">&nbsp;<!--Pula linha--></td></tr>		
