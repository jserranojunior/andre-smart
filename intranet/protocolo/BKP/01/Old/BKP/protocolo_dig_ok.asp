		...
		<tr>
			...
			<input type="button" name="somar" value="+" onFocus="soma(document.form.cd_procedimento.value,document.form.cd_procedimento_1.value,document.form.procedimentos.value)" onKeyup="nextfield ='cd_procedimento';">
			
			&nbsp; <span id='divProc'>&nbsp;				
		<!--select size="1" id="lista" name="cd_procedimento_1" onclick="soma(document.form.cd_procedimento.value,document.form.cd_procedimento_1.value,document.form.procedimentos.value)" onFocus="nextfield ='done';">
		...
		<option value="<%=cd_cod_proc%>" class="inputs""><%=left(rs_proc("nm_procedimento"),25)%></option>
		<%rs_proc.MoveNext
		wend%>
		</select>
		<img src="../imagens/reload6.gif" alt="Atualizar" border="0" onClick="fill_prot();"-->
			
			
			<!--input type="hidden" name="cd_procedimento_0" value=""--></span>
