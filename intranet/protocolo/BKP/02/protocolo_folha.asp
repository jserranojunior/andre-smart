...
<table style="border:1px solid silver; border-collapse:collapse; width:400px;">
	...
	<tr bgcolor="#f5f5f5">
		<td>&nbsp;Cód.: <b><a href="../protocolo.asp?tipo=digitacao&cd_unidade=<%=zero(cd_unidade)%>&cd_protocolo=<%=proto(cd_protocolo)%>&cd_digito=<%=right(digitov(zero(cd_unidade)&"."&proto(cd_protocolo)),1)%>" target="_blank" title="."><%=digitov(zero(cd_unidade)&"."&proto(cd_protocolo))%></a> &nbsp;<%=mensagem%></b></td>
	...
	<tr>
		...
		<td align="left" valign="top">&nbsp;<b><%'=cd_convenio%>
	...
	<tr><td colspan="100%">&nbsp;<!--Pula linha--></td></tr>
			...
			<b>
				<table style="border:0px solid white; border-collapse:collapse;">
					...
					Do while not rs_pat.EOF%>
						...
						<%end if%>
						<tr>
							<td align="right" valign="top">&nbsp;<b><%=rs_pat("nm_tipo")%><%=rs_pat("cd_patrimonio")%></b>&nbsp;&nbsp;</td>
		...
		<tr>
			...
			<td><img src="../imagens/px.gif" alt="" width="235" height="1" border="0"></td>
