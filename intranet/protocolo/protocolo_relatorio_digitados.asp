...
<table align="center" style="border:1px solid gray; font-size: 13px; border-collapse:collapse;" class="no_print">
	<%if session("cd_codigo") = 46 then%>
		<tr><td colspan="100" align="center"><span style="font-size=8px;color:red;">protocolo_relatorio_digitados.asp</span></td></tr>
	<%end if%>
...
<table align="center" class="no_print"><tr><td>1. Selecione o ano e uma Unidade</td></tr></table>
<%elseif ano_sel <> "" AND cd_unidade = "" Then%>
<table align="center" class="no_print"><tr><td>2. Selecione uma Unidade</td></tr></table>
<%elseif ano_sel <> "" AND cd_unidade <> "" Then%>
<table align="center">
