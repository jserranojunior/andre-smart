		<tr bgcolor="#f5f5f5">
			<td colspan="100%">&nbsp;Protocolo: <b><%=cdun(cd_unidade)%>.<%=proto(no_protocolo)%> &nbsp;<%=mensagem%></b></td>
		</tr>
		<tr bgcolor="#808080">
		...
		<tr>
			...
			<td colspan="2">&nbsp;<b><%=cd_especialidade%> - 
		...
		<tr bgcolor="#e0e0e0">
			...
			<td colspan="100%" align="left">
				<table border="0" width="200" cellspacing="3">
				<b>
				<%cab_proc = 0
				'strsql ="Select * from TBL_protocolo_procedimento where cd_protocolo="&cd_protocolo&""
				'strsql ="Select * from TBL_protocolo_procedimento where a002_numpro="&no_protocolo&" AND a053_codung="&cd_unidade&""
				...
				cd_procedimento = rs_prot("a058_codpro")%>
					...
					Set rs = dbconn.execute(strsql)
						...
						<%if cab_proc = "0" then%>
						<tr>
							<td align="right" bgcolor="#c0c0c0">Cód. AMB.&nbsp;</td>
							<td align="left" bgcolor="#c0c0c0">&nbsp;Descrição</td>
						</tr><%end if%><tr>
							<td align="right" valign="top"><b><%=mid(cd_cod_procedimento,1,2)&"."&mid(cd_cod_procedimento,3,2)&"."&mid(cd_cod_procedimento,5,3)&"."&mid(cd_cod_procedimento,8,1)&"<!--br-->"%></b>&nbsp;</td>
					...
					<tr>
						...
						<td><img src="../imagens/px.gif" alt="" width="380" height="1" border="0"></td>
					</tr>
				</table>				
			</b></td>
		</tr>
	<%if nm_agenda = "E" Then%>
		...
		<tr bgcolor="#e0e0e0">
			...
			<table border="0" width="200" cellspacing="3">
			<%head = 0
			strsql ="Select * from TBL_protocolo_patrimonio where cd_protocolo="&cd_cod_protocolo&""
			...
			cd_codigo = rs_pat("cd_codigo")	%>
				...
				<%if head = 0 then%>
				<tr>
					<td align="right" bgcolor="#c0c0c0">Código&nbsp;</td>
					<td align="left" bgcolor="#c0c0c0">&nbsp;Patrimônio</td>
				</tr><%end if%>				
				...
				Set rs = dbconn.execute(strsql)
					...
					'wend%>
					<tr>
						<td align="right" valign="top"><b><%=nm_tipo&no_patrimonio%></b>&nbsp;</td>
