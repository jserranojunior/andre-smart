...
<table align="center">
	...
	<%xsql ="SELECT count(cd_patrimonio) as conta, cd_patrimonio FROM VIEW_protocolo_patrimonio_uso where nm_tipo = 'o' group by cd_patrimonio order by cd_patrimonio"
	...
	linha = 1
		...
		xsql_registros ="SELECT * FROM VIEW_protocolo_patrimonio_uso_0 where nm_tipo = 'o' and cd_patrimonio = '"&cd_patrimonio&"' order by cd_patrimonio"
		...
		wend%>
		<tr><td colspan="8" bgcolor="#c0c0c0">&nbsp;Subtotal: <%'=linha%><%=conta%></td></tr>
		<tr><td>&nbsp;</td></tr>
	<%%>
	<%linha = linha + 1
	rs.movenext
