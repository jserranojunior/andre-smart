...
<body>
<table border="1">
	<tr style="background-color:gray; color:white;"><td colspan="5"> &nbsp; Lista dos nomes da tabela de equipamentos/instrumentos/óticas/materiais &nbsp; </td></tr>
	<tr style="background-color:silver;"><td>Nº</td><td>Status</td><td>Item</td><td align="center">Manut</td><td align="center">Patr</td><td>Cod</td></tr>
	<%num_linha = 0
	num_linha_pag = 0
	xsql_eqp = "Select * From TBL_equipamento order by nm_equipamento"
		...
		Do while not rs_eqp.EOF
			...
			<tr>
				...
				<td align="center">&nbsp;<%xsql = "Select distinct cd_equipamento From VIEW_os_lista2 where cd_equipamento = '"&cd_equip&"'"
