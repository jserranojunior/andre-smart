...
<body>
<table border="1">
	<tr style="background-color:gray; color:white;"><td colspan="3"> &nbsp; Lista dos nomes da tabela de equipamentos/instrumentos/<b>óticas</b>/materiais &nbsp; </td></tr>
	<tr style="background-color:silver;"><td>Nº</td><td>Status</td><td>Item</td><td align="center">M</td></tr>
	<%num_linha = 0
	num_linha_pag = 0
	xsql_eqp = "Select * From TBL_equipamento where cd_status=1 and nm_equipamento_novo is not Null and cd_tipo = 2 order by nm_equipamento_novo"
