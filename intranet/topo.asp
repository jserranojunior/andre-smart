...
<body bgcolor="#FFFFFF"  leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" onLoad="foco_protocolo();">
	...
	<span style="border:0px solid orange; position:absolute; width:498px; left:210px; top:0px; margin:0px; padding:0px;" class="no_print">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <B>Est� o seu acesso n� <%=session("nr_qtd_acasso")%> , �ltimo acesso em <%=session("dt_ultimo_acesso")%>&nbsp;&nbsp;&nbsp;</b></span>	
