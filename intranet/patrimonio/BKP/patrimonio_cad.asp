...
<tr style="background-color:<%=cor_tabela%>;">
    ...
    <td><input type="text" name="cd_dia" size="2" maxlength="2" value="<%=dt_dia%>" class="inputs" onKeyPress="ChecarTAB();" onKeyUp="Mostra(this, 2)" onFocus="PararTAB(this);">/
					...
					<input type="text" name="cd_ano" size="4" maxlength="4" value="<%=dt_ano%>" class="inputs" onFocus="nextfield ='cd_nf';"></td>
</tr>
<tr style="background-color:<%=cor_tabela%>;">
	...
	<td><%if cd_nf <> "" AND str_nf = "" Then%>
		...
		<%else
			...
			<input type="text" name="cd_nf" value="<%=cd_nf%>" size="30" maxlength="50" class="inputs" onFocus="nextfield ='cd_unidade';">
		<%end if%>
	</td>
	<td colspan="2">&nbsp;</td>
</tr>
			...
			<tr style="background-color:<%=cor_emprest%>;">
				...
				<td>
					<select name="cd_situacao" onFocus="nextfield ='dia_emprestimo';">
						...
						<option value="6" <%'if cd_situacao = 4 then response.write("SELECTED") end if%>>Estoque</option>
...
<tr style="background-color:<%=cor_tabela%>;">
    <td>&nbsp;</td>
    <td><%if cd_status < "2" then%><input type="submit" name="envia" value=" OK "><%end if%> <br><font color="red"><%=mensagem%></font></td>
