...
arquivo_loc = "patrimonio_plan_serv.asp"
...
<table class="no_print" style="border:1 solid green; left:150px;" align="center">
	...
	<tr ><td colspan="2" align="center"></form><b><%=mensagem%></b>
					<div id="save" style="border:3px solid green; background-color:#dbfdd7; width:200;position:relative; display:none; visibility:hiddden; left:240px; top:-50px;" class="no_print">
...
for i = 1 to qtd_prevent
	...
	strsql = "SELECT "&prevs_max&" FROM VIEW_patrimonio_lista_servicos WHERE "&prevs_cond&" AND (cd_unidade = "&strcd_unidade&")"
	Set rs_prevs = dbconn.execute(strsql)
		while not rs_prevs.EOF
			if rs_prevs("prevs") = 1 then
				str_display = "block"
			else
				str_display = "none"
			end if
	...
	'***************************************************************%>
<%if i <= 2 then%>
	<table class="txt" border="0" width="800" align="center" style="border-collapse:collapse; page-break-after:always; display:<%=str_display%>;">	
<%else%>
	<table class="txt" border="0" width="800" align="center" style="border-collapse:collapse; display:<%=str_display%>;">
<%end if%>
				<%'condicao = " Where dt_descarte is null"
				condicao = " AND dt_descarte is null"
				ordem = " "&ordem&" "
				
				'strsql ="up_patrimonio_lista @ordem= '"&ordem&"', @condicao = '"&condicao&"'"
			if i = 1 then
				strsql = "SELECT * FROM VIEW_patrimonio_lista WHERE cd_unidade_comodato="&strcd_unidade&" AND nm_tipo='E' AND cd_preventiva=1 "&condicao&" order by cd_posicao, nm_equipamento_novo"
			elseif i = 2 then
				strsql = "SELECT * FROM VIEW_patrimonio_lista WHERE cd_unidade_comodato="&strcd_unidade&" AND nm_tipo='E' AND cd_calibracao=1 "&condicao&" order by cd_posicao, nm_equipamento_novo"
			elseif i = 3 then
				strsql = "SELECT * FROM VIEW_patrimonio_lista WHERE cd_unidade_comodato="&strcd_unidade&" AND nm_tipo='E' AND cd_seg_elet=1 "&condicao&" order by cd_posicao, nm_equipamento_novo"
			end if
	...
	<tr>		
		<td align="center">&nbsp;</td>
		<td  valign="bottom">
			<%if cd_unidade = 2 or cd_unidade = 3 or cd_unidade = 15 or cd_unidade = 38 then%><img src="../imagens/logotipo_sao_luiz.gif" alt="" width="120" height="37" border="0"><%end if%>
			</td>
		...
		<%if cd_unidade = 2 or cd_unidade = 3 or cd_unidade = 15 or cd_unidade = 38 then%>
			<img src="../imagens/logotipo_rede_d_or.jpg" alt="" width="90" height="45" border="0">
		<%else%>
			<img src="../imagens/logotipo_vdlap.gif" alt="" width="88" height="35" border="0"><%end if%></td>
	</tr>
	<tr><td align="center"><img src="../imagens/px.gif" alt="" width="10" height="1" border="0"></td><td align="center"><img src="../imagens/px.gif" alt="" width="10" height="1" border="0"></td><td colspan="12" align="center" style="font-size:12px;"><%'if cd_unidade = 20 then%><%if cd_unidade <> 2 AND cd_unidade <> 3 AND cd_unidade <> 15 then%><%=nm_unidade%><%else%><img src="../imagens/px.gif" alt="" width="10" height="1" border="0"><%end if%></td></tr>
	<tr><td colspan="16"><img src="../imagens/x.gif" alt="" width="10" height="1" border="0"></td></tr>
	<tr>
		<td align="center" valign="bottom">&nbsp;</td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>EQUIPAMENTO</b><br><img src="../imagens/px.gif" alt="" width="180" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>CONTROLE DE<br>MANUTENÇÃO</b><br><img src="../imagens/px.gif" alt="" width="100" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>MARCA</b><br><img src="../imagens/px.gif" alt="" width="100" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>MODELO</b><br><img src="../imagens/px.gif" alt="" width="80" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>Nº SÉRIE</b><br><img src="../imagens/px.gif" alt="" width="80" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>PERIODICIDADE</b><br><img src="../imagens/px.gif" alt="" width="90" height="1" border="0"></td>		
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>JAN</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>FEV</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>MAR</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>ABR</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>MAI</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>JUN</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>JUL</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>AGO</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>SET</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>OUT</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>NOV</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
		<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>DEZ</b><br><img src="../imagens/px.gif" alt="" width="20" height="1" border="0"></td>
	</tr>
	<%end if%>
	
	<%data_agora = zero(month(now))&"/"&zero(day(now))&"/"&year(now)%>
		
		<%if linha > qtd_lim_linhas then%>
			<!--tr class="ok_print"><td>&nbsp;</td></tr-->
			<tr class="ok_print" style="page-break-after:always;"><td colspan="15">&nbsp;</td><td align="center" colspan="3">&nbsp;<%'=linha&"/"&qtd_lim_linhas%><b><%=zero(day(now))&"/"&zero(month(now))&"/"&year(now)%></b></td></tr>
			<!--tr>
				<td><img src="../imagens/blackdot.gif" alt="" width="10" height="15" border="0"></td>
				<td><img src="../imagens/px.gif" alt="" width="75" height="1" border="0"><--no_print></td>	
				<td><img src="../imagens/px.gif" alt="" width="10" height="5" border="0"><--no_print></td>	
			...
			<tr class="ok_print"><td align="center">&nbsp;</td><td align="center">&nbsp;</td><td colspan="12" align="center" style="font-size:12px;"><%'if cd_unidade = 20 then%><%if cd_unidade <> 2 AND cd_unidade <> 3 AND cd_unidade <> 15 then%><%=nm_unidade%><%end if%></td></tr>
			<tr class="ok_print"><td colspan="16"><img src="../imagens/px.gif" alt="" width="10" height="5" border="0"></td></tr>
			<tr class="ok_print">
				<td align="center" valign="bottom">&nbsp;</td>
				...
				<td align="center" valign="bottom" style="<%=estilo_corpo%>"><b>Nº SÉRIE</b></td>
	...
	<tr onmouseover="mOvr(this,'#CFC8FF');"   onmouseout="mOut(this,'');">
		<td align="center" valign="bottom">&nbsp;<%'=linha&"/"&qtd_lim_linhas%><%'=i%></td>
		<td valign="top" align="left" style="<%=estilo_corpo%>">&nbsp;<a href="javascript:void(0);" onclick="window.open('patrimonio/patrimonio_cad.asp?tipo=cadastro&cd_pat_codigo=<%=cd_pat_codigo%>&acao=alterar&jan=2','Alterações','width=700,height=600,scrollbars=1');"><%=nm_equipamento%></a></td>
	...
	if i = 1 then%>
		<td valign="top" align="center"  style="<%=estilo_corpo%>">&nbsp;<%=dt_periodicidade_prev%> <%if dt_periodicidade_prev <> "" Then response.write("meses") end if%></td>
						...
						for imes = monta_grade_i to monta_grade_f
							...
							if instr(1,meses,";"&imes&";",1) <> 0 then
								if garantia = dt_selecionada then
									marca = "<a href=javascript:void(0); onclick=window.open('patrimonio/patrimonio_cad_manutencoes.asp?tipo=cadastro&mes_atribuido="&mes_atribuido&"&ano_atribuido="&ano_sel&"&tipo_manut="&i&"&"&var_plan_prev&"','nome','width=400,height=250'); return false;><img src='../imagens/x0.gif' height='15' border='0'></a>"
								else
									marca = "<a href=javascript:void(0); onclick=window.open('patrimonio/patrimonio_cad_manutencoes.asp?tipo=cadastro&mes_atribuido="&mes_atribuido&"&ano_atribuido="&ano_sel&"&tipo_manut="&i&"&"&var_plan_prev&"','nome','width=400,height=250'); return false;><img src='../imagens/x1.gif' height='15' border='0'></a>"
	...
	elseif i = 2 then%>
		<td valign="top" align="center" style="<%=estilo_corpo%>">&nbsp;<%=dt_periodicidade_cal%> <%if dt_periodicidade_cal <> "" Then response.write("meses") end if%></td>
		<%'*** Resgata o ultimo registro ***
		strsql ="SELECT top 1 * FROM TBL_patrimonio_manutencoes WHERE cd_patrimonio="&cd_pat_codigo&" and cd_suspenso <> 1 AND tipo_manut = "&i&" AND (dt_plan_prev <= '12/31/"&ano_sel&"') order by dt_plan_prev desc"
			Set rs_prev = dbconn.execute(strsql)
				'while not rs_prev.EOF
	...
	<%linha = linha + 1
	elseif i = 3 then%>
		<td valign="top" align="center" style="<%=estilo_corpo%>">&nbsp;<%=dt_periodicidade_elet%> <%if dt_periodicidade_elet <> "" Then response.write("meses") end if%></td>
		<%'*** Resgata o ultimo registro ***
		strsql ="SELECT top 1 * FROM TBL_patrimonio_manutencoes WHERE cd_patrimonio="&cd_pat_codigo&" and cd_suspenso <> 1 AND tipo_manut = "&i&" AND (dt_plan_prev <= '12/31/"&ano_sel&"') order by dt_plan_prev desc"
			Set rs_prev = dbconn.execute(strsql)
				'while not rs_prev.EOF
				...
				'wend
						...
						for imes = monta_grade_i to monta_grade_f
							...
							garantia = year(dt_garantia)&zero(month(dt_garantia))&"01"
								...
								if instr(1,meses,";"&imes&";",1) <> 0 then
									if garantia = dt_selecionada then
										marca = "<a href=javascript:void(0); onclick=window.open('patrimonio/patrimonio_cad_manutencoes.asp?tipo=cadastro&mes_atribuido="&mes_atribuido&"&ano_atribuido="&ano_sel&"&tipo_manut="&i&"&"&var_plan_prev&"&jan=1','nome','width=400,height=250'); return false;><img src='../imagens/x0.gif' height=15 border='0'></a>"
									else
										marca = "<a href=javascript:void(0); onclick=window.open('patrimonio/patrimonio_cad_manutencoes.asp?tipo=cadastro&mes_atribuido="&mes_atribuido&"&ano_atribuido="&ano_sel&"&tipo_manut="&i&"&"&var_plan_prev&"&jan=1','nome','width=400,height=250'); return false;><img src='../imagens/x1.gif' height=15 border='0'></a>"
										mes_servico = mes_atribuido
									end if
								else
									marca = "<a href=javascript:void(0); onclick=window.open('patrimonio/patrimonio_cad_manutencoes.asp?tipo=cadastro&mes_atribuido="&mes_atribuido&"&ano_atribuido="&ano_sel&"&tipo_manut="&i&"&"&var_plan_prev&"&jan=1','nome','width=400,height=250'); return false;><img src='../imagens/x0.gif' height=15 border='0'></a>"
	...
	loop%>
	<%if cd_unidade = 2 or cd_unidade = 15 or cd_unidade = 38000 then%>
	<tr>
		<td align="center" valign="bottom">&nbsp;</td>
		<td colspan="5"><!--ITA20211.PQ.006-->ANF20211.PQ.003 - ANEXO 3 - PLANEJAMENTO DE SERVIÇOS - VDLAP<p>OBS.: As datas marcadas são referentes a <%=tipo_servico%></p></td>
	</tr>
	...
	<%Elseif cd_unidade = 3 then%>
	<tr>
		<td align="center" valign="bottom">&nbsp;</td>
		<td colspan="5"><!--ITA20211.PQ.006-->MOR20211.PQ.008 - ANEXO 3 - PLANEJAMENTO DE SERVIÇOS - VDLAP<p>OBS.: As datas marcadas são referentes a <%=tipo_servico%></p></td>
	</tr>
	<%conteudo = conteudo&"$"&i&";"&strcd_unidade&";0;0;ITA20211.PQ.006 - ANEXO 3 - PLANEJAMENTO DE SERVIÇOS - VDLAP<p>OBS.: As datas marcadas são referentes a "&tipo_servico&";0;0;0;0" 
	end if%>
	<tr>
		...
		<td colspan="14">
			...
			Set rs_prev = dbconn.execute(strsql)
				if not rs_prev.EOF Then
					...
					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href=javascript:void(0); onclick=window.open('patrimonio/patrimonio_cad_manut_obs.asp?cd_obs=<%=cd_obs%>&jan=1','nome','width=400,height=230'); return false;>&nbsp;<%=nm_obs%></a><img src="../imagens/ic_del.gif" alt="" width="13" height="14" border="0" onclick="javascript:JsDelObs('<%=cd_obs%>')" class="no_print">
					<%conteudo = conteudo&"$"&i&";"&strcd_unidade&";0;0;"&nm_obs&";0;0;0;0"
				else%>
					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href=javascript:void(0); onclick=window.open('patrimonio/patrimonio_cad_manut_obs.asp?ano_atribuido=<%=ano_sel%>&tipo_manut=<%=i%>&cd_unidade=<%=cd_unidade%>&jan=1','nome','width=400,height=230'); return false;>&nbsp;<img src='../imagens/ic_novo.gif' border='0' class="no_print"></a>
				<%end if%></td>
...
<%end if%>
<form  name="gravarbkp" class="no_print">
	<input type="hidden" name="ano_bkp" value="<%=ano_sel%>">
	<input type="hidden" name="unidade_bkp" value="<%=cd_unidade%>">
</form>
