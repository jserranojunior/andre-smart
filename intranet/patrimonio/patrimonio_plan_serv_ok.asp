...
<%end if%>
	...
	<tr>
		...
		<td class="ok_print"><img src="../imagens/px.gif" alt="" width="75" height="1" border="0"></td>	
		<td class="no_print"><img src="../imagens/px.gif" alt="" width="10" height="5" border="0"></td>	
	...
	<tr><td align="center">&nbsp;</td><td align="center">&nbsp;</td><td colspan="12" align="center" style="font-size:12px;"><%'if cd_unidade = 20 then%><%if cd_unidade <> 2 AND cd_unidade <> 3 AND cd_unidade <> 15 then%><%=nm_unidade%><%end if%></td></tr>
	<tr><td colspan="16"><img src="../imagens/px.gif" alt="" width="10" height="5" border="0"></td></tr>
	<tr>
	...
	<tr onmouseover="mOvr(this,'#CFC8FF');"   onmouseout="mOut(this,'');">
		<td align="center" valign="bottom">&nbsp;<%'=linha&"/"&qtd_lim_linhas%></td>
							...
							garantia = year(dt_garantia)&zero(month(dt_garantia))&"01"
								...
								if instr(1,meses,";"&imes&";",1) <> 0 then
									if garantia = dt_selecionada then
										...
										marca = "<a href='javascript:void(0);' onclick='window.open('patrimonio/patrimonio_cad_manutencoes.asp?tipo=cadastro&mes_atribuido="&mes_atribuido&"&ano_atribuido="&ano_sel&"&tipo_manut="&i&"&"&var_plan_prev&"&jan=1','nome1','width=400,height=250'); return false;'><img src='../imagens/x0.gif' height=15 border='0'></a>"
									else
										'marca = "<a href=javascript:void(0); onclick=window.open('patrimonio/patrimonio_cad_manutencoes.asp?tipo=cadastro&mes_atribuido="&mes_atribuido&"&ano_atribuido="&ano_sel&"&tipo_manut="&i&"&"&var_plan_prev&"&jan=1','nome','width=400,height=250'); return false;><img src='../imagens/x1.gif' height=15 border='0'></a>"
										marca = "<a href='javascript:void(0);' onclick='window.open('patrimonio/patrimonio_cad_manutencoes.asp?tipo=cadastro&mes_atribuido="&mes_atribuido&"&ano_atribuido="&ano_sel&"&tipo_manut="&i&"&"&var_plan_prev&"&jan=1','nome2','width=400,height=250'); return false;'><img src='../imagens/x1.gif' height=15 border='0'></a>"
										mes_servico = mes_atribuido
									end if
								else
									marca = "<a href='javascript:void(0);' onclick='window.open('patrimonio/patrimonio_cad_manutencoes.asp?tipo=cadastro&mes_atribuido="&mes_atribuido&"&ano_atribuido="&ano_sel&"&tipo_manut="&i&"&"&var_plan_prev&"&jan=1','nome3','width=400,height=250'); return false;'><img src='../imagens/x0.gif' height=15 border='0'></a>"
								end if%>					
...
<form  name="gravarbkp" class="no_print">
	<input type="hidden" name="ano_bkp" value="<%=ano_sel%>"  class="no_print">
	<input type="hidden" name="unidade_bkp" value="<%=cd_unidade%>"  class="no_print">
</form>
