						...
						Set rs_pat = dbconn.execute(xsql)
							...
							'end if
								...
								<tr style="background-color:silver; color:#4a4a4a">
									...
									<td align="center"><b>Mês</b><br><img src="../imagens/px.gif" alt="" width="30" height="1" border="0"></td>
									<td align="center"><b>&nbsp;</b><br><img src="../imagens/px.gif" alt="" width="5" height="1" border="0"></td>
								</tr>
								<%cab_num = cab_num + 1
								end if%>
							...
							<%'if confirmacao = 1 Then
								if not rs_pat.EOF then
									...
									<tr onmouseover="mOvr(this,'#CFC8FF');" onmouseout="mOut(this,'');">
										<td align="center" style="background-color:<%=cor_vencimento%>;"><%=zero(num_linha)%></td>
										...
										<!--td><%'=cd_categoria%></td-->
										<td align="center"><span><%'=dt_vencimento%></span><%=mesdoano(month(dt_plan_prev))%><%'=dt_plan_prev%></td>
