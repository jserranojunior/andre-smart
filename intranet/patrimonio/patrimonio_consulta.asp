...
<tr>
    <td>&nbsp; <b>Unidade atual:</b></td>
		<%strsql ="SELECT * FROM TBL_unidades WHERE cd_codigo = "&cd_unidade_comodato&""
		Set rs_uni = dbconn.execute(strsql)%>
    <td>	<%Do While Not rs_uni.eof%>
				<%=rs_uni("nm_unidade")%>
				<%rs_uni.movenext
...
<tr>
	...
	<b></b>  &nbsp; &nbsp; &nbsp; &nbsp; <%if cd_preventiva = 1 then%><%=dt_periodicidade_prev%> <b>Meses</b> <%end if%>&nbsp; &nbsp; &nbsp; &nbsp;
	</td>
</tr>
<tr>
	<td>&nbsp; <b>Calibração:</b></td>
	<td colspan="3"><%if cd_calibracao = 1 then%>[X]<%Else%>[&nbsp;&nbsp;]<%end if%> <b>Aplicavel?</b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
	<b></b>  &nbsp; &nbsp; &nbsp; &nbsp; <%if cd_calibracao = 1 then%><%=dt_periodicidade_cal%> <b>Meses</b> <%end if%>&nbsp; &nbsp; &nbsp; &nbsp; 
	</td>
</tr>
<tr>
	<td>&nbsp; <b>Segurança Elet.:</b></td>
	<td colspan="3"><%if cd_seg_elet = 1 then%>[X]<%Else%>[&nbsp;&nbsp;]<%end if%> <b>Aplicavel?</b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
	<b></b>  &nbsp; &nbsp; &nbsp; &nbsp; <%if cd_seg_elet = 1 then%><%=dt_periodicidade_elet%> <b>Meses</b> <%end if%>&nbsp; &nbsp; &nbsp; &nbsp;
	</td>
