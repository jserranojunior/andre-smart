...
<%if ocorrencias_mostrar = 1 Then%>
	<table border="0" width="550"><tr bgcolor="#b4b4b4">
	<tr bgcolor="#b4b4b4"><td colspan="100%" align="center" class="textopadrao">OCORRÊNCIAS<br>
		<img src="../../imagens/blackdot.gif" width="580" height="1"></td></tr>
	<tr bgcolor="#f5f5f5">
	...
	<%strsql ="SELECT * From TBL_ocorrencias where id_origem='"&id_origem&"' AND cd_origem='"&cd_origem&"' Order by dt_ocorrencia"
