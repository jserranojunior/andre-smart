...
<!--include file="../../empresa/horas_trabalhadas/horas_trab_horas.asp"-->
<!--mes_sel=3&ano_sel=2008&cd_codigo=97&tela=0&cd_origem=2"-->
<%
...
<%
	...
	response.redirect("../empresa.asp?tipo=encerramento")
