...
If cd_convenio = "" Then '*** Mostra campo normal ***%>
	...
	<b style="color:green;">Digite o nome do convênio</b>
...
<%Else%>
	...
	Set rs_conv = dbconn.execute(xsql)%>
	<select size="1" id="lista" name="cd_convenio_1" onChange="alimenta_convenio(this.value);">
...
<img src="../../imagens/blackdot.gif" alt="" width="1" height="1" border="0" onLoad="alimenta_convenio(<%=cd_convenio%>);">
<%end if%>