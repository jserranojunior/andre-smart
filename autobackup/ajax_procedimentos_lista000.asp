...
'response.write(procedimentos_total)
		...
		if IsNumeric(proc_item) then
			...
			if cor_num = "1" then
				...
				<tr bgcolor="<%=cor_fundo%>">
					...
					<td bgcolor="#ffffff"><input type="button" name="subtrair" value="-" onFocus="soma('','<%=cd_cod_proced%>',document.getElementById('procedimentos_total').value)" onKeyup="nextfield ='cd_procedimento_busca';">
					<!--onFocus="soma('','<%=cd_cod_proced%>',document.form.procedimentos_total.value)"-->
					</td>					
				</tr>
